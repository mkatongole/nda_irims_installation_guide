 ...
 */
Ext.define('Admin.view.importexportpermits.views.toolbars.FoodImportExportPermitsTb', {
    extend: 'Ext.toolbar.Toolbar',
    xtype: 'foodimportexportpermitstb',
    itemId: 'importexportpermitstb',
    ui: 'footer',
    defaults: {
        //arrowAlign: 'bottom',
        ui: 'soft-green',
    ...
    items: [
        {
            ...
            sec_dashboard:'foodimportexportpermitsdash',
            name: 'permithome_btn'
        },
        {
