 ...
 * Kip on 9/24/2018.
 */
Ext.define('Admin.view.importexportpermits.views.sharedinterfaces.panels.ControlledDrugsReceivingPermitsWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.controlleddrugsreceivingpermitswizard',
    padding: '2 0 2 0',
    requires: [
    ...
    items: [{
        ...
        {
            xtype: 'controlleddrugspermitsdetailspnl',//onlinefoodproductsdetailspnl
            dockedItems: [
                {
                    xtype: 'toolbar',
                    ui: 'footer',
            ...
            title: 'Controlled Drugs Permit Prechecking'
        },
        {
            xtype: 'hiddenfield',
            name: 'active_application_id'
            ...
            items: [
                {
                    ...
                    wizard: 'controlleddrugsreceivingpermitswizard',
                ...
                },
                {
                    ...
                    action: 'quickNav', wizard: 'controlleddrugsreceivingpermitswizard',
                    handler: 'quickNavigation'
                }, {
                    step: 2,
                    ...
                    enableToggle: true,iconAlign:'top',
                    text: 'Controlled Drugs Permit Checklist',
                    action: 'quickNav', 
                    wizard: 'controlleddrugsreceivingpermitswizard',
                    handler: 'quickNavigation'
                }
