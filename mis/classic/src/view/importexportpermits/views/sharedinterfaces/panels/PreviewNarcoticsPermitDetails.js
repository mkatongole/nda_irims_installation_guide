 ...
 * Kip on 9/24/2018.
 */
Ext.define('Admin.view.importexportpermits.views.sharedinterfaces.panels.PreviewNarcoticsPermitDetails', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.previewnarcoticspermitdetails',
    padding: '2 0 2 0',
    requires: [
    ...
    items: [
        {
            xtype: 'narcoticspermitsdetailspnl',//onlinefoodproductsdetailspnl
            dockedItems: [
                {
                    xtype: 'toolbar',
                    ui: 'footer',
    ...
    initComponent: function () {
        ...
        this.tbar = {
            ...
            items: [{
                    ...
                    action: 'quickNav', 
                    wizard: 'previewnarcoticspermitdetails',
