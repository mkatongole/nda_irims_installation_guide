 ...
 */
Ext.define('Admin.view.importexportpermits.views.grids.common_grids.HospitalPermitsNarcoticsDashGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'importexportpermitsvctr',
    xtype: 'hospitalpermitsnarcoticsdashgrid',
    itemId: 'hospitalpermitsnarcoticsdashgrid',
    ...
    store: 'hospitalpermitsnarcoticsdashstr',
    listeners: {
    ...
    bbar: [{
        ...
        beforeLoad: function () {
            ...
            this.up('hospitalpermitsnarcoticsdashgrid').fireEvent('refresh', this);
