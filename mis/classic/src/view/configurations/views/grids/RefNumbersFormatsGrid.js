 ...
 */
Ext.define('Admin.view.configurations.views.grids.RefNumbersFormatsGrid', {
    ...
    tbar: [{
        ...
        action: 'add',
        ui: 'soft-green',
        childXtype: 'refnumbersformatsfrm',
        winTitle: 'Reference Number Format',
        winWidth: '40%',
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                ...
                proxy: {
                    url: 'configurations/getRefnumbersformats'
                }
            },
            isLoad: true
        }
    ...
    columns: [{
        ...
        xtype: 'gridcolumn',
        dataIndex: 'refnumbers_type_name',
        text: 'Reference Number Types',
        flex: 1
    },{
        xtype: 'gridcolumn',
