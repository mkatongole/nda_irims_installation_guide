...
Ext.define('Admin.view.configurations.views.grids.ControlledDrugsPermitFeesConfigGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'configurationsvctr',
    xtype: 'controlleddrugspermitfeesconfiggrid',
    ...
    tbar: [{
        ...
        action: 'add',
        ui: 'soft-green',
        childXtype: 'controlleddrugspermitfeesconfigfrm',
        winTitle: 'Controlled Drugs Permits Fee Configurations',
        winWidth: '70%',
        ...
        widget: {
            ...
            menu: {
                ...
                items: [{
                    ...
                    action: 'edit',
                    childXtype: 'controlleddrugspermitfeesconfigfrm',
                    winTitle: 'Controlled Drugs  Fee Configurations',
                    winWidth: '70%',
