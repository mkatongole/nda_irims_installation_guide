Ext.define('Admin.view.configurations.views.grids.AdvertisementTypeGrid', {
    ...
    tbar: [{
        ...
        action: 'add',
        ui: 'soft-green',
        childXtype: 'AdvertisementTypeForm',
        winTitle: 'Add Advertisement Type',
        winWidth: '40%',
    ...
    export_title: 'Advertisement Type',
   bbar: [{
        xtype: 'pagingtoolbar',
        width: '100%',
        displayInfo: true,
