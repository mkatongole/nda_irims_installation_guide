...
Ext.define('Admin.view.configurations.views.grids.MarketingAuthorisationFeeConfigGrid', {
    ...
    columns: [{
        ...
        text: ' Device Type(Mandatory for Medical devices)',
        tdCls: 'wrap',
         flex:1
    },{
        xtype: 'gridcolumn',
        ...
        xtype: 'gridcolumn',
        dataIndex: 'vetmedicines_registrationtype',
        text: 'Veterinary Medicines Registration Type',
        tdCls: 'wrap',
         flex:1
    },{
        xtype: 'gridcolumn',
        dataIndex: 'manufactureredin_eastafrica',
        text: 'Is Manufacturered In East Africa',
        tdCls: 'wrap',
         flex:1,
