...
Ext.define('Admin.view.configurations.views.grids.ControlledDrugsConvFactorsConfigGrid', {
    ...
    tbar: [{
        ...
        action: 'add',
        ui: 'soft-green',
        childXtype: 'controlleddrugsconvfactorsconfigfrm',
        winTitle: 'Controlled Drugs Conversion Factors Config',
        winWidth: '50%',
    ...
    columns: [{
        ...
        text: 'Controlled Drugs Base Salt',
        flex: 1
    },{
        xtype: 'gridcolumn',
        ...
        xtype: 'gridcolumn',
        dataIndex: 'appr_pureanhydrousdrug_contents',
        text: 'Appr Pure Anhydrous Drug',
        flex: 1
    },{
        xtype: 'gridcolumn',
