...
Ext.define('Admin.view.configurations.views.grids.AuthorityDirectorsGrid', {
    ...
    tbar: [{
        ...
        action: 'add',
        ui: 'soft-green',
        childXtype: 'authoritydirectorsFrm',
        winTitle: 'Authority Directors',
        winWidth: '40%',
    ...
    export_title: 'authoritydirectors',
    bbar: [{
        xtype: 'pagingtoolbar',
        width: '100%',
        displayInfo: true,
