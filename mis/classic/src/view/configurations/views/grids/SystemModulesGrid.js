 ...
 */
Ext.define('Admin.view.configurations.views.grids.SystemModulesGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'configurationsvctr',
    xtype: 'systemModulesGrid',
    cls: 'dashboard-todo-list',
    autoScroll: true,
    autoHeight: true, title: 'Modules',
    width: '100%',
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                ...
                proxy: {
                    url: 'configurations/getsystemModules',
                    extraParams: {
                        table_name: 'modules'
                    }
                }
