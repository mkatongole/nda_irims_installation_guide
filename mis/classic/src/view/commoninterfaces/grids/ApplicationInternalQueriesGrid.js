Ext.define('Admin.view.commoninterfaces.grids.ApplicationInternalQueriesGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'commoninterfacesVctr',
    xtype: 'applicationinternalqueriesgrid',
    itemId: 'applicationinternalqueriesgrid',
    ...
    width: '100%',
    height: 600,
    storeID: 'applicationinternalqueriesstr',
    viewConfig: {
    ...
    tbar: [{
        ...
        ui: 'soft-green',
        name: 'add_query',
        handler: 'showAddApplicationInternalQueryForm',
        stores: '[]',
        bind: {
            hidden: '{isReadOnly}'
        }
        ...
        beforerender: {
            ...
            config: {
               ...
               // groupField: 'query_type_id',
                proxy: {
                    url: 'getApplicationInternalqueries'
                }
            },
            isLoad: true
        },
        afterrender: function () {
            ...
            grid.columns[grid.columns.length - 1].widget.menu.items = [
                ...
                },
                {
                    ...
                    iconCls: 'x-fa fa-edit',
                    tooltip: 'Respond to Query',
                    action: 'respond_query',
                    childXtype: 'applicationinternalqueryresponsepnl',
                    winTitle: 'Application Responses',
                    winWidth: '80%',
                    document_type_id: 18,
                    handler: 'showEditApplicationInternalQueryResponseForm',
                    stores: '[]',
                    hidden: false,
                },  
                {
    ...
    export_title: 'Internal Query Results',
    bbar: [{
        xtype: 'pagingtoolbar',
        width: '80%',
        displayInfo: true,
        ...
        emptyMsg: 'No Records',
        beforeLoad: function () {
            this.up('applicationinternalqueriesgrid').fireEvent('refresh', this);
        }
    },'->',{
