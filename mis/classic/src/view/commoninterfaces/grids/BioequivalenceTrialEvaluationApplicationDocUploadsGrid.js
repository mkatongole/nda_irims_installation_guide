Ext.define('Admin.view.commoninterfaces.grids.BioequivalenceTrialEvaluationApplicationDocUploadsGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'commoninterfacesVctr',
    xtype: 'bioequivalencetrialevaluationapplicationdocuploadsgrid',
    ...
    bbar: [{
        ...
        emptyMsg: 'No Records',
        beforeLoad: function () {
            this.up('bioequivalencetrialevaluationapplicationdocuploadsgrid').fireEvent('refresh', this);
        }
    }],
    selModel:{
