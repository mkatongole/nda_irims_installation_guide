Ext.define('Admin.view.commoninterfaces.grids.BioequivalenceTrialReviewApplicationDocUploadsGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'commoninterfacesVctr',
    xtype: 'bioequivalencetrialreviewapplicationdocuploadsgrid',
    cls: 'dashboard-todo-list',
    viewModel: 'commoninterfacesVm',
    autoScroll: true,
    autoHeight: true,
    width: '100%',
    storeID: 'bioequivalencetrialreviewapplicationdocuploadsStr',
    viewConfig: {
    ...
    }, 
    {
        ...
        winWidth: '40%',
        show_assessor: true,
        stores: '["bioequivalencetrialreviewapplicationdocuploadsStr"]',
        storeID: 'bioequivalencetrialreviewapplicationdocuploadsStr',
        // bind: {
        //     hidden: '{isReadOnly}'
        // }
    ...
    bbar: [{
        ...
        emptyMsg: 'No Records',
        beforeLoad: function () {
            this.up('bioequivalencetrialreviewapplicationdocuploadsgrid').fireEvent('refresh', this);
        }
    }],
    selModel:{
