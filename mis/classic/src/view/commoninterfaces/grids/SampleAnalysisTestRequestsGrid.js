Ext.define('Admin.view.commoninterfaces.grids.SampleAnalysisTestRequestsGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'commoninterfacesVctr',
    xtype: 'sampleanalysistestrequestsgrid',
    itemId: 'sampleanalysistestrequestsgrid',
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                pageSize: 1000,
                storeId: 'sampleanalysistestrequestsstr',
                groupField: 'analysis_type_id',
                proxy: {
                    url: 'sampleanalysis/getsampleanalysistestrequests',
                }
            },
            isLoad: true
        }
    ...
    bbar: [{
        ...
        emptyMsg: 'No Records',
        beforeLoad: function () {
            this.up('sampleanalysistestrequestsgrid').fireEvent('refresh', this);
        }
    }],
    features: [{
        ftype: 'searching',
        ...
        ftype: 'grouping',
        startCollapsed: true,
        groupHeaderTpl: 'Analysis Type: {[values.rows[0].data.analysis_type]}',
    ...
    columns: [{
        ...
        xtype: 'gridcolumn',
        dataIndex: 'sample_testapproval_date',
        text: 'sample Test Approval Date',
        flex: 1
    },  {
        xtype: 'gridcolumn',
        ...
        widget: {
            ...
            menu: {
                ...
                items: [{
                    ...
                    text: 'Sample Tests Processes',
                    iconCls: 'x-fa fa-history',
                    childXtype: 'sampleanalysistestrequestsprocessesgrid',
                    winWidth: '70%',
                    winTitle: 'Sample test Analysis Submissions',
                    handler: 'viewsampleanalysistestrequestsProcesses',
                    stores: '[]',
                    bind: {
