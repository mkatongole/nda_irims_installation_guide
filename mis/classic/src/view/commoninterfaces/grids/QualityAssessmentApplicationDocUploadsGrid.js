Ext.define('Admin.view.commoninterfaces.grids.QualityAssessmentApplicationDocUploadsGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'commoninterfacesVctr',
    
    xtype: 'qualityassessmentapplicationdocuploadsgrid',
    cls: 'dashboard-todo-list',
    viewModel: 'commoninterfacesVm',
    autoScroll: true,
    autoHeight: true,
    width: '100%',
    storeID: 'qualityassessmentapplicationdocuploadsStr',
    viewConfig: {
    ...
    }, 
    {
        ...
        winWidth: '40%',
        show_assessor: true,
        stores: '["qualityassessmentapplicationdocuploadsStr"]',
        storeID: 'qualityassessmentapplicationdocuploadsStr',
        bind: {
            hidden: '{isReadOnly}'
        }
    ...
    bbar: [{
        ...
        emptyMsg: 'No Records',
        beforeLoad: function () {
            this.up('qualityassessmentapplicationdocuploadsgrid').fireEvent('refresh', this);
        }
    }],
    selModel:{
