Ext.define('Admin.view.commoninterfaces.grids.QualityReviewApplicationDocUploadsGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'commoninterfacesVctr',
    
    xtype: 'qualityreviewapplicationdocuploadsgrid',
    ...
    bbar: [{
        ...
        emptyMsg: 'No Records',
        beforeLoad: function () {
            this.up('qualityreviewapplicationdocuploadsgrid').fireEvent('refresh', this);
        }
    }],
     selModel:{
