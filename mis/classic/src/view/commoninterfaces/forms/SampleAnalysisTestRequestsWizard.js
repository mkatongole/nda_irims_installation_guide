 ...
 */
Ext.define('Admin.view.commoninterfaces.forms.SampleAnalysisTestRequestsWizard', {
    extend: 'Ext.form.Panel',
    xtype: 'sampleanalysistestrequestswizard',
    controller: 'commoninterfacesVctr',
    requires: [
        'Ext.layout.container.*',
        'Ext.toolbar.Fill'
    ],
    reference: 'sampleanalysistestrequestswizard',
    layout: 'card',
    flex: 1,
    autoScroll: true,
    ...
    initComponent: function () {
        ...
        this.tbar = {
            ...
            items: [{
                ...
                action: 'quickNav',
                iconAlign: 'left',
                wizard: 'sampleanalysistestrequestswizard',
