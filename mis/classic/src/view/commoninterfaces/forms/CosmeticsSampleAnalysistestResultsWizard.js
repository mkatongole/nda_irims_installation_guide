...
Ext.define('Admin.view.commoninterfaces.forms.CosmeticsSampleAnalysistestResultsWizard', {
    extend: 'Ext.form.Panel',
    xtype: 'cosmeticssampleanalysistestresultswizard',
    ...
    reference: 'cosmeticssampleanalysistestresultswizard',
    layout: 'card',
    flex: 1,
    autoScroll: true,
    ...
    initComponent: function () {
        ...
        this.tbar = {
            ...
            items: [{
                ...
                scale:'medium',
                iconAlign: 'top',
                wizard: 'cosmeticssampleanalysistestresultswizard',
        ...
        this.bbar = {
            ...
            items: [
                ...
                },
                {
                    ...
                    name: 'save_btn',
                    disabled: false,
                    wizardpnl: 'cosmeticssampleanalysistestresultswizard',
