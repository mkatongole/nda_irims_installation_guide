 ...
 */
Ext.define('Admin.view.controldocument_management.views.maininterfaces.NewDocumentControlRequest', {
    extend: 'Ext.panel.Panel',
    xtype: 'newdocumentcontrolrequest',
    controller: 'controldocumentmanagementvctr',
    viewModel: 'controldocumentmanagementvm',
    layout: 'fit',is_readonly: false,
    dockedItems: [{
        xtype: 'toolbar',
        dock: 'top',
        ui: 'footer',
