Ext.define('Admin.view.reports.appsreports.controlleddrugsreport.grid.ImportPermitTabularRepresentationGrid', {
    ...
    autoHeight: true,
    width: '100%',
    export_title:'Controlled Drugs Import Permit Summary',
    viewConfig: {
              ...
              listeners: {
                    beforerender: {
                        ...
                        config: {
                            ...
                            storeId: 'importpermittabularrepresentationgridstr',
                            proxy: {
                                url: 'newreports/getControlledDrugsImportPermitSummaryReport',
                                extraParams: {
                                        module_id: 12
                                    }
                            }
