...
Ext.define('Admin.view.reports.appsreport.applicationprocessingreport.grids.ApplicationProcessingByUserReportGrid', {
    extend: 'Ext.grid.Panel',
    xtype: 'applicationprocessingbyuserreportgrid',
    itemId:'applicationprocessingbyuserreportgrid',
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                pageSize: 100000,
                storeId: 'applicationprocessingbyuserreportgridstr',
                remoteFilter:true,
                grouper: {
