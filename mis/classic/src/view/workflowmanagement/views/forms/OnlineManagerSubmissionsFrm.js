 ...
 */
Ext.define('Admin.view.workflowmanagement.views.forms.OnlineManagerSubmissionsFrm', {
    extend: 'Ext.form.Panel',
    xtype: 'onlinemanagersubmissionsfrm',
    autoScroll: true,
        ...
        items: [{
            ...
            listeners: {
                change: function (cmb, newVal) {
                    var thisStore = cmb.getStore(),
                        form = cmb.up('form'),
                        responsible_users = form.down('combo[name=premisesvalidation_respuser_id]');
                        store = responsible_users.store;
                        store.removeAll();
                        store.load({params: {next_stage: newVal}});
                }
            ...
            xtype: 'combo',
            fieldLabel: 'Premises Registration Validation Responsible User(Optional)',
    ...
    dockedItems: [
        {
            ...
            items: [
                '->', {
                    ...
                    formBind: true,
                    ui: 'soft-purple',
                    action_url: 'workflow/receiveMultipleOnlineApplicationDetails'
                }, {
                    text: 'Close',
