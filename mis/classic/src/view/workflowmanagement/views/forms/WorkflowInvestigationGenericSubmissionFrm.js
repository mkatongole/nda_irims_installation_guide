...
Ext.define('Admin.view.workflowmanagement.views.forms.WorkflowInvestigationGenericSubmissionFrm', {
    extend: 'Ext.form.Panel',
    xtype: 'workflowinvestigationGenericsubmissionsfrm',
    autoScroll: true,
