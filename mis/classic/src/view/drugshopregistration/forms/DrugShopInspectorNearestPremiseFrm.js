 ...
 */
Ext.define('Admin.view.drugshopregistration.views.forms.DrugShopInspectorNearestPremiseFrm', {
    extend: 'Ext.form.Panel',
    xtype: 'drugshopinspectornearestpremiseFrm',
    itemId: 'drugshopinspectornearestpremisefrm',
    scrollable:'true',
    ...
    items: [
        ...
        },
        {
            xtype: 'hiddenfield',
            name: 'table_name',
            value: 'tra_inspectorpremises_storelocation'
        },
        {
            xtype: 'hiddenfield',
            name: 'country_id',
    ...
    buttons: [
        {
            ...
            formBind: true,
            table_name: 'tra_inspectorpremises_storelocation',
            storeID: 'nearestinspectorpremisestr',
            action_url: 'premiseregistration/onSavePremisesInspectoreStoreLocationDetails',
