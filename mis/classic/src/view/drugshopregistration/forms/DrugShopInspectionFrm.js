                 ...
                 listeners: {
                    afterrender: function (fieldcontainer) {
                        ...
                        if (recommendedSizeField) {
                            ...
                            fieldcontainer.setFieldLabel('Size in square meters (Recommended Size for ' + premiseType + ' is: ' + recommendedSize + ')');
                        }
                    }
                },
                items:[{
                ...
                listeners: {
                    afterrender: function (fieldcontainer) {
                        ...
                        if (recommendedDistanceField) {
                            ...
                            fieldcontainer.setFieldLabel('Nearest Drug Shop(Recommended Distance for ' + premiseType + ' ' + locationDefinition + ' is: ' + recommendedDistance + ')');
                        }
                    }
                },
                items:[{
                ...
                items: [
                    {
                        ...
                        displayField: 'name',
                        listConfig: {
                            maxHeight: 400,  // Set the maximum height of the dropdown list
                        },
                        listeners: {
                            afterrender: {
                                fn: 'setParamCombosStore',
