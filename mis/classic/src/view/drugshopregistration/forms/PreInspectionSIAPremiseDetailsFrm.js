...
Ext.define('Admin.view.drugshopregistration.views.forms.PreInspectionSIAPremiseDetailsFrm', {
    extend: 'Ext.form.Panel',
    xtype: 'preinspectionsiapremisedetailsfrm',
    itemId: 'preinspectionsiapremisedetailsfrm',
    scrollable: true,
    layout: {
        type: 'column'
    },
    ...
    },
    {
        ...
        value: token
            ...
            xtype:'fieldset',
            columnWidth: 1,
            title: 'Surgical Instrument Premise Details',
            collapsible: true,
            defaults: {
                labelAlign: 'top',
                allowBlank: false,
