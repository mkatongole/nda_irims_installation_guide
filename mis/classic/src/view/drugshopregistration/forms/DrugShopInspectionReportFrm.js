                 ...
                 listeners: {
                    afterrender: function (fieldcontainer) {
                        ...
                        if (recommendedSizeField) {
                            ...
                            fieldcontainer.setFieldLabel('Size of Drug Shop in square meters (Recommended Size for ' + premiseType + ' is: ' + recommendedSize + ')');
                        }
                    }
                },
                items:[{
                ...
                tbar: [
                    ...
                    bbar: [{
                        ...
                        beforeLoad: function () {
                            ...
                            grid = this.up('grid'),
                            form= grid.up('form');
                            if(Ext.ComponentQuery.query("#drugshopinspectionreportfrm")[0]){
                                premise_id = Ext.ComponentQuery.query("#drugshopinspectionreportfrm")[0].down('hiddenfield[name=premise_id]').getValue();
                            }else{
                 ...
                 listeners: {
                    afterrender: function (fieldcontainer) {
                        ...
                        if (recommendedDistanceField) {
                            ...
                            var premiseType = premiseTypeField.getValue();
                            fieldcontainer.setFieldLabel('Nearest Drug Shop (Recommended Distance for ' + premiseType + ' is: ' + recommendedDistance + ')');
                        }
                    }
                },
                items:[{
