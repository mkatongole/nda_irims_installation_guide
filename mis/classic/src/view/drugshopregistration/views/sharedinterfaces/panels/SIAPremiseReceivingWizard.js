...
Ext.define('Admin.view.drugshopregistration.views.sharedinterfaces.panels.SIAPremiseReceivingWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.siapremisereceivingwizard',
    ...
    items: [
        {
            ...
            tbar:[ {
                ...
                ui: 'soft-red',
                childXtype: 'preinspectionsiapremiseselectiongrid',
            ...
            items: [
                {
                    ...
                    wizard_pnl : 'siapremisereceivingwizard',
                    action: 'quickNav'
                },{
                    step: 1,
                    iconCls: 'fa fa-user',
