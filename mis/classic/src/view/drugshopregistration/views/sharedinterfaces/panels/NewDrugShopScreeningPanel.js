 ...
 */
Ext.define('Admin.view.drugshopregistration.views.sharedinterfaces.panels.NewDrugShopScreeningPanel', {
    extend: 'Ext.panel.Panel',
    xtype: 'newdrugshopevaluationpanel',
    layout: {
        type: 'border'
    },
    defaults: {
    ...
    items: [{
            title: 'Drug Shop Information & Assessment',
            region: 'center',
            layout: 'fit',
