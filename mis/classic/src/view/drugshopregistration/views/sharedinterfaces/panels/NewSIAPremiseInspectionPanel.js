 ...
 */
Ext.define('Admin.view.drugshopregistration.views.sharedinterfaces.panels.NewSIAPremiseInspectionPanel', {
    extend: 'Ext.panel.Panel',
    xtype: 'newsiapremiseinspectionpanel',
    layout: {
        type: 'border'
    },
    defaults: {
    ...
    items: [
        {
            ...
            items: [{
                    ...
                    xtype:'siapremiseappmoredetailswizard'
                },{
                   ...
                   title: 'Inspection Checklist'
                    ...
                    listeners:{
                        beforerender:function(pnl){
                            ...
                            premise_id = mainPnl.down('siapremisedetailsfrm').down('hiddenfield[name=premise_id]').getValue();
