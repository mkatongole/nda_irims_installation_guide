...
Ext.define('Admin.view.drugshopregistration.views.sharedinterfaces.panels.RenewalDrugShopReceivingWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.renewaldrugshopreceivingwizard',
    ...
    items: [
        {
            ...
            tbar:[ {
                ...
                winTitle: 'New Drugshop Applications due for Renewal Selection List',
                winWidth: '90%',
                margin: '30 0 0 0'
            }]
            ...
            items: [
                {
                    ...
                    wizard_pnl : 'renewaldrugshopreceivingwizard',
                    action: 'quickNav'
                },{
                    step: 1,
                    iconCls: 'fa fa-user',
