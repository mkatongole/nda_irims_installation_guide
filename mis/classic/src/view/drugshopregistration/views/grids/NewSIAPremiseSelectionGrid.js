 ...
 */
Ext.define('Admin.view.premiseregistration.views.grids.NewSIAPremiseSelectionGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'premiseregistrationvctr',
    xtype: 'newsiapremiseselectiongrid',
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                ...
                remoteFilter: true,
                proxy: {
                    url: 'premiseregistration/getSIAPremiseRenewalList',
					reader: {
                        type: 'json',
