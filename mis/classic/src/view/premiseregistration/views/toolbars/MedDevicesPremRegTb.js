 ...
 */
Ext.define('Admin.view.premiseregistration.views.toolbars.MedDevicesPremRegTb', {
    ...
    items: [
        {
            ...
            name: 'medDevicesPremiseRegHomeBtn'
        },
        {
                ...
                items:[
                    {
                        ...
                        wrapper_xtype: 'meddevicespremregdashwrapper',
                        app_type: 1
                    },
                    '-',
                    {
                    ...
                    '-',
                    {
                        ...
                        wrapper: 'meddevicespremregdashwrapper',
