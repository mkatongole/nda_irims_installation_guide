 ...
 */
Ext.define('Admin.view.premiseregistration.views.panels.cancellation.CancelPremiseOnlinePreviewWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.cancelpremiseonlinepreviewwizard',
    padding: '2 0 2 0',
    name: 'wizardPanel',
    requires: [
    ...
    items: [
        ...
        {
            xtype: 'applicationwithdrawalreasonsonlinegrid'
        }
    ],
