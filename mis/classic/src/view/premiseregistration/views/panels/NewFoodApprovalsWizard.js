 ...
 */
Ext.define('Admin.view.premiseregistration.views.panels.NewFoodApprovalsWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.newfoodapprovalswizard',
    padding: '2 0 2 0',
    requires: [
    ...
    items: [
        ...
        {
            xtype: 'premisedetailstabpnl'//'premisedetailsfrm'
        },
        {
