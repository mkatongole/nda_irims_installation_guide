 ...
 */
Ext.define('Admin.view.premiseregistration.views.sharedinterfaces.panels.NewPremiseTcMeetingPnl', {
    extend: 'Ext.panel.Panel',
    title: 'Pending Applications',
    xtype: 'newPremiseTcMeetingpnl',
    layout: 'border',
    defaults: {
        split: true,
    },
    ...
    items: [
        ...
        },
        {
                ...
                items: [
                    {
                        ...
                        text: 'TC Meeting Uploads & Export',
                        ui: 'soft-purple',
...

                     {
                        ...
                        gridXtype:'premiseManagerMeetingGrid',
                        table_name: 'tra_premise_applications',
            ...
            items:[{
                title: 'Participants',
                xtype: 'premiseTcMeetingParticipantsGrid',//productTcMeetingParticipantsGrid
                listeners: {
