 ...
 */
Ext.define('Admin.view.productregistration.views.sharedinterfaces.panels.NewPremiseTcReviewMeetingpnl', {
    extend: 'Ext.panel.Panel',
    title: 'Pending Applications',
    xtype: 'newPremiseTcReviewMeetingpnl',
    layout: 'border',
    defaults: {
        split: true,
    },
                ...
                items: [
                    {
                        ...
                        labelWidth: 150,
                        width: 200,
                        fieldLabel: 'IL TC Recommendation',
                        name: 'decision_id',
                        allowBlank: true,
                        listeners: {
                            beforerender: {
