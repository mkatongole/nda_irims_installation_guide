 ...
 */
Ext.define('Admin.view.premiseregistration.views.sharedinterfaces.panels.PremiseTcReviewReportInspectionReview', {
    extend: 'Ext.panel.Panel',
    title: 'Pending Applications',
    xtype: 'premisetcreviewreportinspectionreview',
    layout: 'border',
    defaults: {
        split: true,
    },
    ...
    items: [
        {
            ...
            region: 'north',
            height: 110,
            xtype: 'premiseMeetingDetailsFrm'//productMeetingDetailsFrm
        },
        {
            title: 'Applications',
            region: 'center',
            xtype: 'premisetcreviewreportinspectionreviewgrid',//premiseReviewTCMeetingGrid
            dockedItems: [{
                xtype: 'toolbar',
                ui: 'footer',
                scrollable: true,
