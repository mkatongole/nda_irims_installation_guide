 ...
 */
Ext.define('Admin.view.premiseregistration.views.grids.AllPremiseAppSelectionGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'premiseregistrationvctr',
    xtype: 'allpremiseappselectiongrid',
    itemId: 'allpremiseappselectiongridId',
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                ...
                remoteFilter: true,
                proxy: {
                    url: 'premiseregistration/getPremisesAppList',
					reader: {
                        type: 'json',
