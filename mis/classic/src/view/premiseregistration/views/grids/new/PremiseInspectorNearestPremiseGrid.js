...
Ext.define('Admin.view.drugshopregistration.views.grids.PremiseInspectorNearestPremiseGrid', {
    ...
    tbar: [{
        ...
        ui: 'soft-green',
        childXtype: 'drugshopinspectornearestpremiseFrm',
        winWidth: '70%',
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                ...
                proxy: {
                    url: 'premiseregistration/getPremisesInspectionStoreLocationDetails'
                }
            },
            isLoad: true
        },
