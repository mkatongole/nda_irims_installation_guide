...
Ext.define('Admin.view.premiseregistration.views.grids.PreInspectionDrugsPremRegGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'premiseregistrationvctr',
    xtype: 'preinspectiondrugspremreggrid',
    ...
    export_title: 'Premise Pre-Inspection applications',
    bbar: [{
        xtype: 'pagingtoolbar',
        width: '100%',
