 ...
 */
Ext.define('Admin.view.premiseregistration.views.grids.PremiseManagerCapaSubmissionGrid', {
    ...
    viewConfig: {
        ...
        getRowClass: function (record, rowIndex, rowParams, store) {
            var caparequest_id = record.get('caparequest_id');
            if (caparequest_id < 1) {
                return 'invalid-row';
            }
        },
    ...
    listeners: {
        ...
        beforeselect: function (sel, record, index, eOpts) {
            ...
            if (caparequest_id > 0) {
                ...
                toastr.warning('Please enter the CAPA REquests Details before submission', 'Warning Response');
                    ...
                    items: [
                        {
                            ...
                            handler: 'showInspectionCAPApplicationQueries'
                        },
                        {
                            text: 'Checklists',
