 ...
 */
Ext.define('Admin.view.premiseregistration.views.grids.PremiseManagerReinspectionSubmissionGrid', {
    ...
    viewConfig: {
        ...
        getRowClass: function (record, rowIndex, rowParams, store) {
            var reinspection_submission = record.get('reinspection_submission');
            if (reinspection_submission < 1) {
                return 'invalid-row';
            }
        },
        listeners: {
    ...
    listeners: {
        ...
        beforeselect: function (sel, record, index, eOpts) {
            ...
            if (reinspection_submission > 0) {
                ...
                toastr.warning('Please enter the Re-Inspection REquests Details before submission', 'Warning Response');
        ...
        },
        {
            ...
            widget: {
                ...
                menu: {
                    ...
                    items: [
                        {
                            text: 'Preview/Add Re-Inspection Request',
                            iconCls: 'x-fa fa-cubes',
                            handler: 'showReinspectionRequestswin'
                        },
                        {
                            text: 'Checklists',
