 ...
 */
Ext.define('Admin.view.gmpapplications.views.panels.alteration.AltGmpReceivingWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.altgmpreceivingwizard',
            ...
            items: [
                {
                    ...
                    listeners: {
                        ...
                        change: function (cmbo, newVal) {
                            var pnl = cmbo.up('altgmpreceivingwizard'),
