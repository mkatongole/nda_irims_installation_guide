Ext.define('Admin.view.plugins.Searching', {
	...
	onRender:function() {
		...
		if(this.shortcutKey && this.shortcutModifier) {
			...
			// this.keymap = new Ext.util.KeyMap(shortcutEl, {
			// 	 key:this.shortcutKey
			// 	,scope:this
			// 	,stopEvent:true
			// 	,handler: function() {
	...
	,onTriggerSearch:function() {
		...
		// your proxy must be a Server proxy
			...
			var gridComp=this.grid,
				menuComp=this.menu;
			this.grid.fireEvent('searchGridData',gridComp,val,menuComp);
			/*
