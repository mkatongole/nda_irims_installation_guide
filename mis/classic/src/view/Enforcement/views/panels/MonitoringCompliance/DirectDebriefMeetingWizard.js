Ext.define('Admin.view.Enforcement.views.panels.MonitoringCompliance.DirectDebriefMeetingWizard', {
    extend: 'Ext.panel.Panel',
    xtype: 'directDebriefMeetingWizard',
    ...
    items: [{
        ...
        xtype: 'directdebriefApplicationGrid',
