Ext.define('Admin.view.Enforcement.views.panels.MonitoringCompliance.MonitoringPeerReviewSchedulingPnl', {
    extend: 'Ext.panel.Panel',
    xtype: 'monitoringPeerReviewSchedulingPnl',
    ...
    items: [{
        ...
        is_meeting: 0,//on all tcmeetingparticipantsgrid to differentiate when called from meeting/schedule
        title: 'Applications Ready For the Meeting',
        header: {
            style: {
                backgroundColor: '#2eadf5'
            }
