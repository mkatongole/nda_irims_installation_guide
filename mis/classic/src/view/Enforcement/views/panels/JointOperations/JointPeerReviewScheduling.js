Ext.define('Admin.view.Enforcement.views.panels.JointOperations.JointPeerReviewScheduling', {
    extend: 'Ext.panel.Panel',
    xtype: 'jointPeerReviewScheduling',
    ...
    items: [{
        ...
        is_meeting: 0,//on all tcmeetingparticipantsgrid to differentiate when called from meeting/schedule
        title: 'Joint Operations Reports Ready For the Meeting',
        header: {
            style: {
                backgroundColor: '#2eadf5'
            }
