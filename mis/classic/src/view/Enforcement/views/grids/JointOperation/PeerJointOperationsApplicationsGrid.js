Ext.define('Admin.view.Enforcement.views.grids.JointOperation.PeerJointOperationsApplicationsGrid', {
    extend: 'Ext.grid.Panel',
    xtype: 'peerJointOperationsApplicationsGrid',
        ...
        beforerender: {
            ...
            config: {
                ...
                proxy: {
					...
					//getStageJointOperationsApplications
                }
            },
            isLoad: true
        },
	        ...
	        widget: {
	            ...
	            menu: {
	                ...
	                items: [
		                ...
		                hidden: true,
		                // review_type: 1,
		                handler: 'showJointRecommendationWin'
		            },
					{
					...
					{
	                    text: 'view/update Joint Operation Report',
	                    iconCls: 'fa fa-list-alt',
