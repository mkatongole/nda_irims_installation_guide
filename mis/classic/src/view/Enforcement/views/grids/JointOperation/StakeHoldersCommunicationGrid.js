 ...
 */
 Ext.define('Admin.view.Enforcement.views.grids.JointOperation.StakeHoldersCommunicationGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'enforcementvctr',
    xtype: 'stakeHoldersCommunicationGrid',
    autoScroll: true,
    width: '100%',
    viewConfig: {
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                ...
                proxy: {
                    url: 'enforcement/getJointOperationsApplications'
                }
            },
            isLoad: true
        },
    ...
    {
        xtype: 'gridcolumn',
        dataIndex: 'internal_operative',
        text: 'Internal Operative',
        flex: 1
    },
    {
        xtype: 'gridcolumn',
        dataIndex: 'external_operative',
        text: 'External Operative',
        flex: 1
    },
    {
        text: 'Options',
        ...
        widget: {
            ...
            menu: {
                ...
                items: [
                    ...
                    {
	                    text: 'view Product siezed',
	                    iconCls: 'fa fa-list-alt',
	                    tooltip: 'view Product siezed',
	                    ui: 'soft-blue',
	                    handler: 'showJointSeizedProducts',
	                    stores: '[]'
	                },
					{
	                    text: 'view Offence detected',
	                    iconCls: 'fa fa-list-alt',
	                    tooltip: 'view Offence detected',
	                    ui: 'soft-blue',
	                    handler: 'showJointDetectedOffences',
	                    stores: '[]'
	                },
                    {
	                    text: 'view Joint Operation Summary/actions',
	                    iconCls: 'fa fa-list-alt',
	                    tooltip: 'view Joint Operation Summary',
                        ui: 'soft-blue',
	                    handler: 'showJointSummary',
	                    stores: '[]'
	                },
                    {
                    ...
                    {
	                    text: 'view Joint Operation Report',
	                    iconCls: 'fa fa-list-alt',
	                    tooltip: 'view investigation reports',
	                    name: 'view_report',
	                    winTitle: 'Joint Operation Report',
	                    winWidth: '70%',
	                    ui: 'soft-blue',
