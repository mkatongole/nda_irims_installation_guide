 ...
 */
 Ext.define('Admin.view.Enforcement.views.grids.MonitoringCompliance.MysteryShoppingGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'enforcementvctr',
    xtype: 'mystreyshoppingGrid',
    autoScroll: true,
    width: '100%',
    viewConfig: {
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                pageSize: 10000,
                storeId: 'mystreyshoppingEvaluationStr',
                proxy: {
                    url: 'enforcement/getMystreyShoppingApplications'
                }
            },
            isLoad: true
        },
        ...
        widget: {
            ...
            menu: {
                ...
                items: [
                    ...
                    {
                        text: 'Add A Mystrey Shopping',
                        ui: 'soft-blue', 
                        iconCls: 'x-fa fa-plus',
                        childXtype: 'mystreyShoppingLogGrid',
                        winTitle: 'Mystrey Shopping Log',
                        winWidth: '60%',
                        handler:'MystreyShoppingLog',
                        stores: '[]'
                    },
                    {
