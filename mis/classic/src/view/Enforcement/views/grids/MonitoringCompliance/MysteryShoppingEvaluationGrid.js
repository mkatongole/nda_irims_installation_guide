 ...
 */
 Ext.define('Admin.view.Enforcement.views.grids.MonitoringCompliance.MysteryShoppingEvaluationGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'enforcementvctr',
    xtype: 'mystreyshoppingEvaluationGrid',
    autoScroll: true,
    width: '100%',
    viewConfig: {
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                ...
                proxy: {
                    url: 'enforcement/MystreyShoppingEvaluationApplications'
                }
            },
            isLoad: true
        },
