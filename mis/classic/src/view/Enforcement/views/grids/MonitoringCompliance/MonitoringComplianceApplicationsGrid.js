Ext.define('Admin.view.Enforcement.views.grids.MonitoringCompliance.MonitoringComplianceApplicationsGrid', {
    extend: 'Ext.grid.Panel',
	controller: 'enforcementvctr',
    xtype: 'monitoringComplianceApplicationGrid',
	itemId: 'monitoringComplianceGrid',
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                ...
                remoteFilter: true,
                proxy: {
                    url: 'enforcement/getMonitoringComplianceApplications',
                }
            },
            isLoad: true
        },
		itemdblclick: 'loadMonitoringComplianceWizardFromRecord'
    },
    tbar: [{
    	xtype: 'textfield',
    	name: 'tracking_no',
