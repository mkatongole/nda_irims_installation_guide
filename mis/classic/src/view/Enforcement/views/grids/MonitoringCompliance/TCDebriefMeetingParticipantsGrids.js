 ...
 */
Ext.define('Admin.view.Enforcement.views.grids.MonitoringCompliance.TCDebriefMeetingParticipantsGrids', {
    extend: 'Ext.grid.Panel',
    xtype: 'tcdebriefmeetingparticipantsgrid',
    controller: 'commoninterfacesVctr',
    name: 'tcdebriefmeetingparticipantsgrid',
    ...
    tbar: [
        ...
        },
        {
            ...
            childXtype: 'debriefmeetingparticipantsgrid',
