Ext.define('Admin.view.Enforcement.views.grids.Investigation.OffenceChargeGrid', {
    extend: 'Ext.grid.Panel',
	controller: 'enforcementvctr',
    xtype: 'offenceChargeGrid',
	itemId: 'offenceChargeGrid',
...
plugins: [
    ...
    bbar: [{
        ...
        emptyMsg: 'No Records',
        beforeLoad: function () {
            this.up('offenceChargeGrid').fireEvent('refresh', this);     
          }
    }],
    features: [{
        ftype: 'searching',
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                ...
                proxy: {
                   url: 'enforcement/getCaseOffenceCharges',
                }
            },
            isLoad: true
        },
    ...
    tbar: [
        {
        xtype: 'button',
        text: 'Add Charge Details',
        iconCls: 'x-fa fa-plus',
        ui: 'soft-blue',
        //name: 'add_offence',
        handler: 'showAddConfigChargeWinFrm',
        winTitle: 'Offence Charge Details Form',
        winWidth:'70%',
        childXtype: 'offenceChargesFrm',
        stores: '[]'
    },
    {
		xtype: 'displayfield',
		value: 'click on the options to add potential charge !!',
		fieldStyle: {
			'color': 'green',
			'font-weight': 'bold'}
	},
    ...
    {
        xtype: 'gridcolumn',
        dataIndex: 'reported_offence_details',
                ...
                items: [
                    {
                       ...
                       iconCls: 'x-fa fa-plus',
                        ui: 'soft-blue',
                         handler: 'showAddOffenceChargeWinFrm',
                         winTitle: 'Offence Charge Details Form',
                         winWidth:'60%',
                         childXtype: 'offenceChargesFrm',
                         stores: '[]'
                        ...
                        //      ui: 'soft-blue',
                        //       handler: 'showAddOffenceChargeWinFrm',
                        //       winTitle: 'Charge Witness Details Form',
                        //       winWidth:'70%',
