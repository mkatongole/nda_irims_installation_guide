Ext.define('Admin.view.Enforcement.views.grids.Investigation.SeizureInspectionGrid', {
    extend: 'Ext.grid.Panel',
	controller: 'enforcementvctr',
    xtype: 'seizureinspectiongrid',
	itemId: 'seizureinspectiongrid',
...
plugins: [
    ...
    tbar: [
        {
        xtype: 'button',
        text: 'Add Inspection details',
        iconCls: 'x-fa fa-plus',
        ui: 'soft-blue',
        handler: 'showAddConfigParamWinFrm',
        winTitle: 'Product Seizure Inspection Form',
        winWidth:'70%',
        childXtype: 'seizureInspectionFrm',
        stores: '[]'
    },
	{
		xtype: 'hiddenfield',
