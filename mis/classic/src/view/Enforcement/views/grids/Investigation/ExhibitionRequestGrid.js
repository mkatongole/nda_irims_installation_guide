Ext.define('Admin.view.Enforcement.views.grids.Investigation.ExhibitionRequestGrid', {
    extend: 'Ext.grid.Panel',
	controller: 'enforcementvctr',
    xtype: 'exhibitionRequestGrid',
	itemId: 'exhibitionRequestGrid',
...
bbar: [{
    ...
    beforeLoad: function(){
        var grid = this.up('grid'),
            pnl = grid.up('exhibitionRequestPnl'),
