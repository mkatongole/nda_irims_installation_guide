Ext.define('Admin.view.Enforcement.views.grids.Investigation.SeizureManagerGrid', {
    extend: 'Ext.grid.Panel',
	controller: 'enforcementvctr',
    xtype: 'seizureManagerGrid',
	itemId: 'seizureManagerGrid',
...
bbar: [{
    ...
    beforeLoad: function(){
        var grid = this.up('grid'),
            pnl = grid.up('seizureManagerReviewPnl'),
