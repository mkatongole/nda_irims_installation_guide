Ext.define('Admin.view.Enforcement.views.grids.Investigation.ReleasedGoodsGrid', {
    extend: 'Ext.grid.Panel',
	controller: 'enforcementvctr',
    xtype: 'releasedGoodsGrid',
	itemId: 'releasedGoodsGrid',
            ...
            widget: {
                ...
                menu: {
                    ...
                    items: [
                        ...
                        {
                            text: 'Release Product Confirmation',
                            iconCls: 'fa fa-check',
                            tooltip: 'confirm product release',
                            action: 'edit',
                            childXtype: 'productReleaseConfirmationFrm',
                            winTitle: 'Release Product Confirmation',
                            winWidth: '40%',
