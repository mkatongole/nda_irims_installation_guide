 ...
 */
 Ext.define('Admin.view.Enforcement.views.forms.investigation.EnforcementApprovalRecommFrm', {
    extend: 'Ext.form.Panel',
    xtype: 'enforcementApprovalRecommFrm',
    itemId: 'enforcementApprovalRecommFrmId',
    layout: 'column',
    frame: true,
        ...
        },
        {
            ...
            listeners: {
                beforerender: {
                    ...
                    config: {
                        pageSize: 100,
                        storeId:'enforcementApprovalDecisionsStr',
                        proxy: {
                            extraParams:{
    ...
    dockedItems:[
        {
            ...
            items:[{
                ...
                text: 'Add Authorization Signature',
                name: 'signature_btn',
                margin: '20 0 0 0',
                callerPnl: 'enforcementApprovalRecommFrmId', //item id for reference, all calls are done from widget with itemId
