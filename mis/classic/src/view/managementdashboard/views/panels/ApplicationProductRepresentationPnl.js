Ext.define('Admin.view.managementdashboard.views.panels.ApplicationProductRepresentationPnl', {
    ...
    items: [{
            ...
            listeners: {
                beforerender: {
                    ...
                    config: {
                        pageSize: 1000,
                        storeId: 'productAppDashReportCartesianStr',
                        proxy: {
                ...
                emptyMsg: 'No Records',
                 beforeLoad: function() {
                        var grid=this.up('panel'),
                            ...
                            con = pnl.up('panel');
                            console.log(pnl);
                              var section_id = con.down('combo[name=section_id]').getValue(),
