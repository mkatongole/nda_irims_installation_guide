Ext.define('Admin.view.managementdashboard.views.panels.ApplicationPremiseRepresentationPnl', {
    extend: 'Ext.panel.Panel',
    xtype: 'applicationPremiseRepresentationPnl',
    title: 'Premise Report',
    ...
    items: [{
            ...
            listeners: {
                beforerender: {
                    ...
                    config: {
                        pageSize: 1000,
                        storeId: 'premiseAppDashReportCartesianStr',
                        proxy: {
