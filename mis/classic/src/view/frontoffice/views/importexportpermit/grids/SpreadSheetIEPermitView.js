 Ext.define('Admin.view.frontoffice.importexportpermit.grids.SpreadSheetIEPermitView', {
 extend: 'Ext.grid.Panel',  
   scroll: true,
   width: '100%',
    xtype: 'spreadsheetiepermitview',
   layout: 'fit',
   store: 'spreadsheetiepermitapplicationcolumnsstr',
    title: 'Import/Export Permit SpreadSheet',
