Ext.define('Admin.view.frontoffice.product.container.PublicHealthChemicalSpreadsheet', {
    extend: 'Ext.form.Panel',
    xtype: 'publichealthchemicalspreadsheet',
    layout:'border',
               ...
               items: [{
                  ...
                  listeners: {
                    beforerender: {
                        ...
                        config: {
                            pageSize: 1000,
                            storeId: 'publichealthchemicalspreadsheetstr',
                            proxy: {
