 ...
 * on 9/24/2018.
 */
Ext.define('Admin.view.disposalpermits.views.forms.ParDisposalExternalSupervisorsFrm', {
    extend: 'Ext.form.Panel',
    xtype: 'pardisposalexternalsupervisorsfrm',
    itemId: 'pardisposalexternalsupervisorsfrm',
    layout: {
        type: 'column',
        columns: 1
    },
