 ...
 */
Ext.define('Admin.view.revenuemanagement.views.panels.BatchInvoiceRequestPnl', {
    extend: 'Ext.panel.Panel',
    xtype: 'batchinvoicerequestpnl',
    layout: 'fit',
    dockedItems: [{
            xtype: 'toolbar',
            dock: 'top',
    ...
    bbar:['->',{
        ...
        iconCls: 'x-fa fa-save',
        ui: 'soft-green',
        handler:'funcPrintBatchInvoiceStatement'
    }],
    items: [{
            xtype: 'panel',
            ...
            items:[{
                ...
                region: 'center',
                tbar:[{
                    text:'Add Invoice to Batch',
                    iconCls: 'x-fa fa-plus',
                    handler:'funcAppInvoiceDetailstoBatch',
                    ui: 'soft-green',
                    childXtype: 'linkapplicationinvoicesgrid',
                    winTitle: 'Link Application Invoice',
                    winWidth: '80%',
                    stores: '[]'
                },{
