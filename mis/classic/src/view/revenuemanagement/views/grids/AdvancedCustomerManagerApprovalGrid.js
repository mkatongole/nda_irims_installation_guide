 ...
 Ext.define('Admin.view.RevenueManagement.views.grids.AdvancedCustomerManagerApprovalGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'revenuemanagementvctr',
    xtype: 'advancedCustomerManagerApprovalGrid',
    autoScroll: true,
    width: '100%',
    viewConfig: {
        ...
        widget: {
            ...
            menu: {
                ...
                items: [
		                ...
		                ui: 'soft-blue',
                        handler: 'showCustomerApplicationApprovalDetails',
                        stores: '[]',
                        table_name: 'tra_revenue_details',
	                    winWidth: '70%',
	                    tooltip: 'Decision',
	                   	action: 'edit',
						childXtype: 'advancedCustomerApprovalFrm',
                    ...
                    {
		                text: 'Advanced Customers Register',
		                iconCls: 'fa fa-list-alt',
		                ui: 'soft-blue',
                        winTitle:'Advanced customers',
		                handler: 'showAdvancedCustomerRegister'
		            },
                ]
            }
        }
