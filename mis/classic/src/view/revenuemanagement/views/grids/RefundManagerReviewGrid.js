...
Ext.define('Admin.view.RevenueManagement.views.grids.RefundManagerReviewGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'revenuemanagementvctr',
    xtype: 'refundManagerReviewGrid',
    autoScroll: true,
    width: '100%',
    viewConfig: {
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                pageSize: 10000,
                storeId: 'RefundManagerReviewGridStr',
                proxy: {
        ...
        widget: {
            ...
            menu: {
                ...
                items: [
                    ...
                    {
		                text: 'View Applied Refund Invoices ',
		                iconCls: 'fa fa-list-alt',
		                ui: 'soft-blue',
                        winTitle:'Applied invoices',
		                handler: 'showAppliedRefundInvoices'
		            },
                    {
