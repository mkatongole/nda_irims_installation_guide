...
Ext.define('Admin.view.RevenueManagement.views.grids.RefundApprovalGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'revenuemanagementvctr',
    xtype: 'refundApprovalGrid',
    autoScroll: true,
    width: '100%',
    viewConfig: {
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                pageSize: 10000,
                storeId: 'refundApprovalGridStr',
                proxy: {
                    url: 'revenuemanagement/getRefundApplicationInvoices'
                }
            },
            isLoad: true
        },
        ...
        widget: {
            ...
            menu: {
                ...
                items: [
                    ...
                    {
		                text: 'Approve Invoices for refund',
		                iconCls: 'fa fa-list-alt',
		                ui: 'soft-blue',
                        winTitle:'Approve refund invoices',
                        childXtype: 'invoicesReadyForApprovalGrid',
		                handler: 'showInvoicesApprovalWin'
		            },
                    {
