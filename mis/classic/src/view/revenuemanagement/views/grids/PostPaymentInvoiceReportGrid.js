Ext.define('Admin.view.RevenueManagement.views.grids.PostPaymentInvoiceReportGrid', {
    extend: 'Ext.grid.Panel',
    alias:'widget.postPaymentInvoiceReportGrid',
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                ...
                proxy: {
                    url: 'revenuemanagement/getPostPaymentInvoicesList',
