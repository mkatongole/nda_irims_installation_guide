 ...
 */
Ext.define('Admin.view.revenuemanagement.views.grids.WavePaymentManagementDashGrid', {
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                ...
                proxy: {
                    url: 'revenuemanagement/getWavePaymentManagementDashDetails',
                    reader: {
                        type: 'json',
                        totalProperty: 'totals'
                    },
    ...
    columns: [{
        ...
        text: 'Reason for Payment Waiver',
        flex: 1
    },{
        xtype: 'gridcolumn',
