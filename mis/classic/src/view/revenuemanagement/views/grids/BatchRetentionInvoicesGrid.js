 ...
 */
Ext.define('Admin.view.revenuemanagement.views.grids.BatchRetentionInvoicesGrid', {
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                ...
                proxy: {
                    url: 'revenuemanagement/getBatchRetentionsInvoices',
                    reader: {
                        type: 'json',
    ...
    columns: [{
        ...
        widget: {
            ...
            ui: 'soft-green',
            text: 'Print Invoice Statement',
            handler: 'funcPrintGridRetentionBatchInvoiceStatement'
        }
    },{
        xtype: 'gridcolumn',
        ...
        widget: {
            ...
            ui: 'soft-green',
            text: 'Print Payment Statement',
            handler: 'funcPrintGridRetentionBatchPaymentStatement'
        }
    }],
    bbar: [{
            xtype: 'pagingtoolbar',
