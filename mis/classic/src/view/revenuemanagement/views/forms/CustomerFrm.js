...
Ext.define('Admin.view.RevenueManagement.views.forms.CustomerFrm', {
    ...
    items: [{
        ...
        xtype:'fieldset',
        columnWidth: 1,
        title: 'Requested Customer Upgrade',
        collapsible: true,
        defaults: {
            labelAlign: 'top',
            allowBlank: true,
        ...
        items :[
              ...
              }, 
           {
            ...
            hidden: true,
            name: 'threshold',
            fieldLabel: 'Threshold (IF Applicable)',
            allowBlank: true
        },
          {
           xtype: 'htmleditor',
