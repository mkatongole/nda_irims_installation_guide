Ext.define('Admin.view.regional_assessment.views.grid.GMPRegionalAssessmentProceduresGrid', {
    ...
    listeners: {
        ...
        select: function(sel, record, index, eOpts) {
            var grid = this,
                ...
                country_grid = Ext.ComponentQuery.query("#gmpassessmentcountrygridRef")[0],
