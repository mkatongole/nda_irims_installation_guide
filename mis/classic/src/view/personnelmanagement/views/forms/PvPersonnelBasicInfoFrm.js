...
Ext.define('Admin.view.personnelmanagement.views.forms.PvPersonnelBasicInfoFrm', {
    extend: 'Ext.form.Panel',
    alias: 'widget.pvpersonnelbasicinfofrm',
    bodyPadding: 8,
    ...
    items: [
        {
            ...
            items: [
                {
                    ...
                    margin: '0 20 20 0',
                    name: 'table_name',
                    value: 'tra_pv_personnel_management',
                    allowBlank: true
                },
...

              {
                ...
                allowBlank: false,
                listeners: {
                    change: 'updateModelPvUserNameOnChange'
                }
             },
             {
                    xtype: 'combo',
            ...
            },
            {
                ...
                items: [{
                      ...
                      columnWidth: 0.9,
                      listeners: {
                        change: 'updateModelPvUserEmailOnChange'
                    }
                  },{
                        xtype: 'button',
                        iconCls: 'x-fa fa-plus',
                            ...
                            beforerender: {
                                ...
                                config: {
                                    ...
                                    proxy: {
                                        ...
                                        extraParams:{
                                        table_name: 'par_pv_personnel_designation'
                                    }
                                  }
                                },
                            isLoad: true
