...
Ext.define('Admin.view.personnelmanagement.views.grids.PvPersonnelGrid', {
    ...
    tbar: [{
        xtype: 'button',
        text: 'Add Pharmacovigilance Personnel',
        iconCls: 'x-fa fa-plus',
        action: 'add',
        ui: 'soft-green',
        form: 'pvstaffpnl',
        handler: 'showSimplePvPersonnelModuleGridForm',
        stores: '[]'
    }, {
        xtype: 'exportbtn'
    }, {
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                ...
                proxy: {
                    url: 'personnelmanagement/getPvPersonnelDetails',
                    extraParams:{
        ...
        itemdblclick: 'showPvEditSystemPersonneldbclick'
    },
    columns: [{
        xtype: 'gridcolumn',
        ...
        widget: {
            ...
            menu: {
                ...
                items: [{
                    ...
                    handler: 'showPvEditSystemPersonnel'
                }
                ]
            }
        }
