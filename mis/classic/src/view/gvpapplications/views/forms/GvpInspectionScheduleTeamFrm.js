 ...
 */
Ext.define('Admin.view.gvpapplications.views.forms.GvpInspectionScheduleTeamFrm', {
        ...
        
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    childXtype: 'gvpsearchinspectionschedulesgrid',
            ...
            items: [
                {
                    ...
                    handler: function (btn) {
                        var form = btn.up('form'),
                            addPnl = form.up('gvpschedulingcontainer'),
                ...
                '->',
                {
                    ...
                    table_name: 'gvp_inspectionteam_details'
                }
            ]
        }
    ]
