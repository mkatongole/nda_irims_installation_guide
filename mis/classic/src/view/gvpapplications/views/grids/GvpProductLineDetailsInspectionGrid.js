 ...
 */
Ext.define('Admin.view.gvpapplications.views.grids.GvpProductLineDetailsInspectionGrid', {
            ...
            var store = this.getStore(),
                ...
                if(grid.up('window')){
                    ...
                    if(win.down('gvpassessmentDetailsPnl')){
                      var site_id = win.down('gvpassessmentDetailsPnl').down('hiddenfield[name=manufacturing_site_id]').getValue();
