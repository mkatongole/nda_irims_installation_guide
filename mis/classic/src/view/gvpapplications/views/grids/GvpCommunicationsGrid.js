 ...
 */
Ext.define('Admin.view.gvpapplications.views.grids.GvpCommunicationsGrid', {
    ...
    columns: [{
        ...
        widget: {
            ...
            xtype: 'button',
            ui: 'soft-green',
            text: 'GVP Certificate',
            iconCls: 'x-fa fa-certificate',
            name: 'gvp_cert',
            handler: 'printColumnGvpCertificate'
        }
    },{
        xtype: 'widgetcolumn',
        width: 120,
        ...
        widget: {
            ...
            xtype: 'button',
            ui: 'soft-green',
            text: 'GVP Approval Letter',
            iconCls: 'x-fa fa-certificate',
            name: 'approval_letter',
            handler: 'printColumnGvpApprovalLetter'
        }
    },{
        xtype: 'gridcolumn',
