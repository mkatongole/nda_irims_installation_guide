 ...
 */
Ext.define('Admin.view.gvpapplications.views.grids.GvpAppsForInspectionGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'gvpapplicationsvctr',
    xtype: 'gvpappsforinspectiongrid',
    ...
    dockedItems: [
        {
            ...
            items: [
                ...
                '->',
                {
                    ...
                    disabled: true,
                    winWidth: '50%',
                    handler: 'addGvpApplicationsIntoInspectionSchedule'
                }
            ]
        }
    ],
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                pageSize: 10000,
                proxy: {
                    url: 'gvpapplications/getGvpApplicationsForInspection'
                }
            },
            isLoad: true
        },
