 ...
 */
Ext.define('Admin.view.gvpapplications.views.grids.MedDevicesGvpGrid', {
    ...
    bbar: [{
        xtype: 'pagingtoolbar',
        width: '100%',
        store: 'meddevicesgvpapplicationsstr',
        displayInfo: true,
    ...
    listeners: {
        ...
        itemdblclick: 'onViewGvpApplication'
    },
    store: 'meddevicesgvpapplicationsstr',
    columns: [{
        xtype: 'gridcolumn',
