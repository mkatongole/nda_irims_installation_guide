 ...
 */
Ext.define('Admin.view.gvpapplications.views.panels.cancellation.CancelGvpOnlinePreviewWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.cancelgvponlinepreviewwizard',
    padding: '2 0 2 0',
    name: 'wizardPanel',
    requires: [
    ...
    items: [
        ...
        {
            xtype: 'gvpwithdrawalreasonsonlinegrid'
        },
        {
