 ...
 */
Ext.define('Admin.view.gvpapplications.views.panels.cancellation.CancelGvpReceivingWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.cancelgvpreceivingwizard',
            ...
            items: [
                {
                    ...
                    listeners: {
                        ...
                        change: function (cmbo, newVal) {
                            var pnl = cmbo.up('cancelgvpreceivingwizard'),
    ...
    items: [
        ...
        {
            xtype: 'gvpwithdrawalreasonsgrid'
        }
    ],
