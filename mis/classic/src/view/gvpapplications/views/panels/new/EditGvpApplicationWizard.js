...
Ext.define('Admin.view.gvpapplications.views.panels.new.EditGvpApplicationWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.editgvpapplicationwizard',
    ...
    reference: 'wizardpnl',
    itemId: 'editgvpapplicationwizardId',
    layout: 'card',
    flex: 1,
    autoScroll: true,
            ...
            ,'->',{
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            childXtype: 'allgvpappgrid',
                            winTitle:'GVP Applications',
                            winWidth:'70%',
                            handler: 'showGvpApplicationsSelectionList'
                        }
                    ]
                },{
                    xtype: 'fieldcontainer',
        ...
        this.bbar = {
            ...
            items: [
                ...
                '->',
                {
                    ...
                    name: 'save_btn',
                    toaster: 1,
                    handler: 'saveGvpEditAppBaseDetails'
                },
                {
                    text: 'Next',
                    ui: 'soft-purple',
