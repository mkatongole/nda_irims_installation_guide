 ...
 */
Ext.define('Admin.view.gvpapplications.views.panels.GvpSiteAppMoreDetailsAltWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.gvpsiteappmoredetailsaltwizard',
    ...
    items: [
        ...
        {
            xtype: 'gvpvariationrequestsgrid'
        },
        {
            xtype: 'gvpappprevdocuploadsgenericgrid'
        },
        {
            xtype: 'hiddenfield',
            name: 'process_id'
