 ...
 */
Ext.define('Admin.view.gvpapplications.views.panels.alteration.AltGvpReceivingWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.altgvpreceivingwizard',
            ...
            items: [
                {
                    ...
                    listeners: {
                        ...
                        change: function (cmbo, newVal) {
                            var pnl = cmbo.up('altgvpreceivingwizard'),
