Ext.define('Admin.view.promotionmaterials.views.forms.PromotionMaterialManagerRecommendationDetailsForm', {
    extend: 'Ext.form.Panel',
    xtype: 'promotionmaterialmanagerrecommendationdetailsform',
