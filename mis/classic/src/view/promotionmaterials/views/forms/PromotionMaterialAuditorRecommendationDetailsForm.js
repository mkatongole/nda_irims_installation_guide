Ext.define('Admin.view.promotionmaterials.views.forms.PromotionMaterialAuditorRecommendationDetailsForm', {
    extend: 'Ext.form.Panel',
    xtype: 'promotionmaterialauditorrecommendationdetailsform',
