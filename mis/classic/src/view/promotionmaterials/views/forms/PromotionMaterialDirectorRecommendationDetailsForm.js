Ext.define('Admin.view.promotionmaterials.views.forms.PromotionMaterialDirectorRecommendationDetailsForm', {
    extend: 'Ext.form.Panel',
    xtype: 'promotionmaterialdirectorrecommendationdetailsform',
