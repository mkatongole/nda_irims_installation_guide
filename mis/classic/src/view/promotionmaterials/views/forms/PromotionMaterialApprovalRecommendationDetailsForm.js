Ext.define('Admin.view.promotionmaterials.views.forms.PromotionMaterialApprovalRecommendationDetailsForm', {
    extend: 'Ext.form.Panel',
    xtype: 'promotionmaterialapprovalrecommendationdetailsform',
    ...
    items: [
...

        {
            ...
            xtype: 'combo',
            fieldLabel: 'Recommendation by 1st Assessor',
            //columnWidth: 0.99,
            columnWidth: 1,  
            readOnly:true,
            ...
            readOnly:true, 
			//colSpan:6,
			fieldLabel:'Comments by 1st Assessor'
		},
        {
            xtype: 'combo',
            fieldLabel: '2nd Assessor Recommendation',
            //columnWidth: 0.99,
            columnWidth: 1,
            readOnly:true,   
            name: 'auditors_recommendation_id',
            allowBlank: false,
            forceSelection: true,
            queryMode: 'local',
            valueField: 'id',
            ...
            xtype:'textarea',
            name:'auditors_comments',
            grow: true, 
            readOnly:true, 
            columnWidth: 1, 
            growMax: 600, 
            //colSpan:6,
            fieldLabel:'2nd Assessor Comments'
        },
        {
            xtype: 'combo',
            fieldLabel: 'Manager Recommendation',
            //columnWidth: 0.99,
            columnWidth: 1,  
            readOnly:true, 
            name: 'manager_recommendation_id',
            allowBlank: false,
            forceSelection: true,
            queryMode: 'local',
            valueField: 'id',
        ...
        {
            xtype: 'combo',
            fieldLabel: 'Director Recommendation',
            //columnWidth: 0.99,
            columnWidth: 1,  
            readOnly:true, 
            name: 'director_recommendation_id',
            allowBlank: false,
            forceSelection: true,
            queryMode: 'local',
            valueField: 'id',
    ...
    buttons: [
        {
            ...
            storeID: 'promotionmaterialdetailapprovalrecommendationgridstr',
