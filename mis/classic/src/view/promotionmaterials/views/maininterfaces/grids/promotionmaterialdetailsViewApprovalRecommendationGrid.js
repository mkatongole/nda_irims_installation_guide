Ext.define('Admin.view.view.promotionmaterials.views.grids.promotionmaterialdetailsformViewApprovalRecommendationGrid', {
    extend: 'Ext.grid.Panel',
    xtype: 'promotionmaterialdetailviewapprovalrecommendationgrid',
	...
	tbar: [{
	 ...
	 bbar: [{
			...
			emptyMsg: 'No Records',
			      beforeLoad: function () {
                    this.up('promotionmaterialdetailviewapprovalrecommendationgrid').fireEvent('refresh', this);
        }
    ...
    listeners: {
            beforerender: {
                ...
                config: {
                    pageSize: 1000,
                    storeId: 'promotionmaterialdetailviewapprovalrecommendationgridstr',
                    proxy: {
    ...
    },     
   {
        ...
        widget:{
            ...
            childXtype: 'promotionmaterialapprovalrecommendationdetailsform',
            itemId:'view_sites',
            winWidth: '70%',
            ui: 'soft-green',
            iconCls: 'fa fa-eye',
