Ext.define('Admin.view.view.promotionmaterials.views.grids.promotionmaterialdetailsformApprovalRecommendationGrid', {
    extend: 'Ext.grid.Panel',
    xtype: 'promotionmaterialdetailapprovalrecommendationgrid',
	...
	tbar: [{
	 ...
	 bbar: [{
			...
			emptyMsg: 'No Records',
			      beforeLoad: function () {
                    this.up('promotionmaterialdetailapprovalrecommendationgrid').fireEvent('refresh', this);
        }
