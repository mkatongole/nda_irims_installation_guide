Ext.define('Admin.view.promotionmaterials.views.maininterfaces.panels.PromotionAdvertsAuditingDocPanel', {
    extend: 'Ext.panel.Panel',
	record:1,
    xtype: 'promotionadvertsauditingdocpanel',
