 ...
 */
Ext.define('Admin.view.onlineservices_configuration.views.forms.ApplicationProcessGuidelinesFrm', {
    extend: 'Ext.form.Panel',
    xtype: 'applicationprocessguidelinesfrm',
    ...
    items: [{
        ...
        margin: '0 20 20 0',
        name: 'table_name',
        value: 'par_webappprocess_guidelines',
        allowBlank: true
    }, {
        xtype: 'hiddenfield',
        margin: '0 20 20 0',
		...
		xtype: 'textfield',
        fieldLabel: 'Step(Step Defination)',
        margin: '0 20 20 0',
        name: 'step',
        allowBlank: true
    ...
    dockedItems:[
        {
            ...
            items:[
                '->',{
                    ...
                    action: 'save',
                    table_name: 'par_webappprocess_guidelines',
