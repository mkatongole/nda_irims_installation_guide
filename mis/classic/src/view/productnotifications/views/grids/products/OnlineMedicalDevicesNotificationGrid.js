 ...
 */
Ext.define('Admin.view.productregistration.views.grids.common_grids.OnlineMedicalDevicesNotificationGrid', {
    ...
    export_title: 'Online Product Notifications',
    bbar: [{
        xtype: 'pagingtoolbar',
        width: '100%',
        displayInfo: true,
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                pageSize: 100000,
                storeId: 'onlineproductnotificationsstr',
               groupField:'sub_module',
                proxy: {
                    url: 'productnotification/getOnlineApplications'
                }
            },
            isLoad: true
        },
