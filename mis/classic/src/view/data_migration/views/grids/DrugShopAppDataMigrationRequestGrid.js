...
Ext.define('Admin.view.applicationsammendment.views.grids.DrugShopAppDataMigrationRequestGrid', {
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                storeId: 'drugshopappdatamigrationrequestgridstr',
                pageSize: 200, 
                remoteFilter: false,
        ...
        widget: {
            ...
            menu: {
                ...
                items: [{
                    ...
                    storeID: 'drugshopappdatamigrationrequestgridstr',
                    title: 'Drug Shop Application Migration',
