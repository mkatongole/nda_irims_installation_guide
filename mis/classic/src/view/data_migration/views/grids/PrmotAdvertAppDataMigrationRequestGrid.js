...
Ext.define('Admin.view.applicationsammendment.views.grids.PrmotAdvertAppDataMigrationRequestGrid', {
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                storeId: 'prmotadvertappdatamigrationrequestgridstr',
                pageSize: 200, 
                remoteFilter: false,
        ...
        widget: {
            ...
            menu: {
                ...
                items: [{
                    ...
                    table_name: 'tra_prmotionaladvertapps_datamigration',storeID: 'prmotadvertappdatamigrationrequestgridstr',
                    title: 'Promotional & Advertisements Application Migration',
                    ...
                    table_name: 'tra_datamigrationrequests',
                    storeID: 'clinicaltrialappdatamigrationrequestgridstr',
