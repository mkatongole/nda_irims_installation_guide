...
Ext.define('Admin.view.applicationsammendment.views.grids.PremisesAppDataMigrationRequestGrid', {
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                storeId: 'premisesappdatamigrationrequestgridstr',
                pageSize: 200, 
                remoteFilter: false,
        ...
        widget: {
            ...
            menu: {
                ...
                items: [{
                    ...
                    table_name: 'tra_premisesapps_datamigration',storeID: 'premisesappdatamigrationrequestgridstr',
                    title: 'Premises Application Migration',
