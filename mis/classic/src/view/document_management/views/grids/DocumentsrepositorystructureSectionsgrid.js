 ...
 */
Ext.define('Admin.view.document_management.views.grids.DocumentsrepositorystructureSectionsgrid', {
    extend: 'Ext.grid.Panel',
    controller: 'documentsManagementvctr',
    xtype: 'documentsrepositorystructuresectionsgrid',
    ...
    export_title: 'Sections Repository Structure',
    bbar: [{
        xtype: 'pagingtoolbar',
        width: '100%',
        displayInfo: true,
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                pageSize: 1000,
                storeId: 'documentsectionsrepstructureStr',
                grouper: {
                ...
                proxy: {
                   url: 'documentmanagement/getdocumentsectionsrepstructure'
                }
            },
            isLoad: true
        }
