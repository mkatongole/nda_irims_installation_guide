 ...
 */
Ext.define('Admin.view.document_management.views.grids.SopMastListgrid', {
    ...
    tbar: [{
        ...
        action: 'add',
        ui: 'soft-green',
        childXtype: 'sopMastListfrm',
        winTitle: 'SOP Master List',
        winWidth: '40%',
