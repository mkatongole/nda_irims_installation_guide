 ...
 */
Ext.define('Admin.view.systemadministrationprocess.views.grids.ChangeMarketAuthorisationDashGrid', {
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                ...
                proxy: {
                    url: 'systemadminprocess/getChangemarketAuthorisationdetails',
                    reader: {
                        type: 'json',
                        totalProperty: 'totals'
                    },
