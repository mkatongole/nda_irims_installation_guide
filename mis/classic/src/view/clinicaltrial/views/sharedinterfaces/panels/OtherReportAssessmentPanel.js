 ...
 */
Ext.define('Admin.view.clinicaltrial.views.sharedinterfaces.panels.OtherReportAssessmentPanel', {
    extend: 'Ext.panel.Panel',
    xtype: 'otherreportassessmentpanel',
    layout: {
        type: 'border'
    },
    defaults: {
    ...
    items: [
        {
            ...
            xtype: 'tabpanel',
            items: [{
                xtype: 'ctrotherreportappmoredetailswizard',
                title:'Clinical Trial Other Report Details'
            },{
