...
Ext.define('Admin.view.clinicaltrial.views.maininterfaces.main.EditClinicalTrialReceiving', {
    extend: 'Ext.panel.Panel',
    xtype: 'editclinicaltrialreceiving',
    itemId: 'editclinicaltrialreceivingId',
    ...
    items: [
        {
            xtype: 'editclinicaltrialreceivingwizard'
        }
    ]
});