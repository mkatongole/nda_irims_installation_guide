 ...
 */
Ext.define('Admin.view.clinicaltrial.views.forms.CtrRegistryCollaboratorssFrm', {
    ...
    items: [
        {
            ...
            valueField: 'id',
            displayField: 'name',
            fieldLabel: 'Is Collaborator available for this trial? *',
            ...
            xtype: 'textfield',
            fieldLabel: 'Name of Collaborator',
            name: 'name',
        }, {
            xtype: 'textfield',
