 ...
 */
Ext.define('Admin.view.clinicaltrial.views.grids.RejectedOnlineClinicalTrialGrid', {
    ...
    export_title: 'Online clinical trial applications',
    bbar: [{
        xtype: 'pagingtoolbar',
        width: '100%',
        displayInfo: true,
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                pageSize: 100000,
                storeId: 'rejectedonlineclinicaltrialstr',
                groupField: 'sub_module_id',
                proxy: {
                    url: 'clinicaltrial/getOnlineApplications'
                }
            },
            isLoad: true
        },
