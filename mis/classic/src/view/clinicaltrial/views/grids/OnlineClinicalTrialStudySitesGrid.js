 ...
 */
Ext.define('Admin.view.clinicaltrial.views.grids.OnlineClinicalTrialStudySitesGrid', {
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                pageSize: 10000,
                storeId: 'onlineclinicaltrialstudysitesstr',
                proxy: {
                    url: 'clinicaltrial/getOnlineClinicalStudySites'
                }
            },
            isLoad: true
        }
