 ...
 */
Ext.define('Admin.view.clinicaltrial.views.grids.OnlineClinicalTrialOtherInvestigatorsGrid', {
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                pageSize: 10000,
                storeId: 'onlineclinicaltrialotherinvestigatorsstr',
                proxy: {
                    url: 'clinicaltrial/getOnlineClinicalTrialOtherInvestigators'
                }
            },
            isLoad: true
        }
