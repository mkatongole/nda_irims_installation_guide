 ...
 */
Ext.define('Admin.view.clinicaltrial.views.grids.CtrGcpLetterofComplianceIssuanceGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'clinicaltrialvctr',
    xtype: 'ctrgcpletterofcomplianceissuancegrid',
    ...
    dockedItems: [
        {
            ...
            xtype: 'displayfield',
            value: 'Double click to preview inspection details!!',
            fieldStyle: {
                'color':'green'
            }
        }
    ...
    columns: [{
        ...
        widget: {
            ...
            menu: {
                ...
                items: [
                    {
                        text: 'Preview Clinical Trial Application Details',
