 ...
 */
Ext.define('Admin.view.clinicaltrial.views.panels.ClinicalTrialOtherRptOnlinePreviewWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.clinicaltrialotherrptonlinepreviewwizard',
            ...
            items: [
                {
                    ...
                    action: 'quickNav',
                    handler: 'quickNavigationOtherRptOnlineDetails'
                },
                {
                    step: 1,
                    iconCls: 'fa fa-suitcase',
                    enableToggle: true,
                    text: 'CLINICAL TRIAL OTHER REPORTING DETAILS ',
                    action: 'quickNav',
                    handler: 'quickNavigationOtherRptOnlineDetails'
                },
            ...
            items: [
                {
                    ...
                    name: 'prev_btn',
                    handler: 'onPrevCardClickOtherRptOnlineDetails'
                },
                {
                ...
                },
                {
                    ...
                    name: 'next_btn',
                    handler: 'onNextCardClickOtherRptOnlineDetails'
                }
            ]
        };
