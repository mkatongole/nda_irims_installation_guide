 ...
 */
Ext.define('Admin.view.surveillance.views.toolbars.CosmeticsSurveillanceTb', {
    ...
    items: [
        {
            ...
            name: 'cosmeticsSurveillanceHomeBtn',
            dash_wrapper: 'cosmeticssurveillancedashwrapper',
            dashboard: 'cosmeticssurveillancedashwrapper'
        },
        {
                ...
                items:[
                    {
                        ...
                        wrapper_xtype: 'cosmeticssurveillancedashwrapper',
