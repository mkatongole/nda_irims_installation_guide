 ...
 */
Ext.define('Admin.view.surveillance.views.grids.LabScreeningResultsGrid', {
    ...
    tbar: [
        {
            xtype: 'button',
            text: 'Add Sample Screening Results',
            iconCls: 'x-fa fa-plus',
            ui: 'soft-green',
            winTitle: 'Sample Sample Screening Results',
            winWidth: '35%',
            childXtype: 'labscreeningresultsfrm',
