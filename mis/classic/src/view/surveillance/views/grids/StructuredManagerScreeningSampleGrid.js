 ...
 */
Ext.define('Admin.view.surveillance.views.grids.StructuredManagerScreeningSampleGrid', {
    extend: 'Admin.view.surveillance.views.grids.SampleDetailsAbstractGrid',
    xtype: 'structuredmanagerscreeningsamplegrid',itemId:'evaluationsampledetailsgrid',
    viewConfig: {
