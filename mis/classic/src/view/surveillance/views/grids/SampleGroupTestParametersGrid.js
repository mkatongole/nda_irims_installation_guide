Ext.define('Admin.view.surveillance.views.grids.SampleGroupTestParametersGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'commoninterfacesVctr',
    xtype: 'samplegrouptestparametersgrid',
    itemId: 'samplegrouptestparametersgrid',
    cls: 'dashboard-todo-list',
    autoScroll: true,
    autoHeight: true,
    width: '100%',
    storeID: 'samplegrouptestparametersgridstr',
    viewConfig: {
