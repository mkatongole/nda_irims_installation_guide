 ...
 */
Ext.define('Admin.view.variation_configurations.views.forms.VariationConditions_DetailsFrm', {
    extend: 'Ext.form.Panel',
    xtype: 'variationconditions_detailsfrm',
    ...
    items: [{
        ...
        margin: '0 20 20 0',
        name: 'table_name',
        value: 'par_variationconditions_details',
        allowBlank: true
    }, {
        xtype: 'hiddenfield',
        margin: '0 20 20 0',
