 ...
 */
Ext.define('Admin.view.variation_configurations.views.forms.VariationDescriptionDetailsFrm', {
    extend: 'Ext.form.Panel',
    xtype: 'variationdescriptiondetailsfrm',
    ...
    items: [{
        ...
        xtype: 'combo',
        fieldLabel: 'Has Sub-description',
        margin: '0 20 20 0',
        name: 'has_sub_description',
        valueField: 'id',
        displayField: 'name',
        forceSelection: true,
        allowBlank: true,
