 ...
 */
Ext.define('Admin.view.variation_configurations.views.forms.VariationCategoriesDetailsFrm', {
    extend: 'Ext.form.Panel',
    xtype: 'variationcategoriesdetailsfrm',
    ...
    items: [{
        ...
        margin: '0 20 20 0',
        name: 'table_name',
        value: 'par_variation_categories',
        allowBlank: true
    }, {
        xtype: 'hiddenfield',
        margin: '0 20 20 0',
