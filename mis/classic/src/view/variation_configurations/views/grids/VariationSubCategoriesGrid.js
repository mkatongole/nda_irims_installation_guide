 ...
 */
Ext.define('Admin.view.variation_configurations.views.grids.VariationSubCategoriesGrid', {
    extend: 'Ext.grid.Panel',
   
    controller: 'variationconfigurationsvctr',
    xtype: 'variationsubcategoriesgrid',
    ...
    tbar: [{
        ...
        winTitle: 'Variations Sub-Categories',
        winWidth: '40%',
    ...
    export_title: 'Variation Sub-Categories',
    bbar: [{
        xtype: 'pagingtoolbar',
        width: '100%',
        displayInfo: true,
