Ext.define('Admin.view.productregistration.views.forms.medicaldevices.EditMedicalDevicesProductsDetailsFrm', {
    extend: 'Ext.form.Panel',
    xtype: 'editmedicaldevicesproductsdetailsfrm',
    itemId: 'editproductsDetailsFrm',
    layout: {
        type: 'column'
    },
    viewModel: {
    ...
    items: [{
        ...
        },
        {
            ...
            items: [{
                ...
                childXtype: 'allmedicaldeviceappgrid',
                winTitle: 'Registered Medical Devices',
                winWidth: '89%',
                handler: 'editregisteredProductsSearch'
            }]
        },
        {
            xtype: 'combo',
