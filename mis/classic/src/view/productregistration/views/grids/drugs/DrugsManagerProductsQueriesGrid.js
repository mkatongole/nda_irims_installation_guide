Ext.define('Admin.view.commoninterfaces.grids.DrugsManagerProductsQueriesGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'productregistrationvctr',
    xtype: 'drugsmanagerproductsqueriesgrid',
    itemId: 'drugsmanagerproductsqueriesgrid',
    cls: 'dashboard-todo-list',
    autoScroll: true,
    autoHeight: true,
    width: '100%',
    storeID: 'drugsmanagerproductsqueriesgridstr',
    viewConfig: {
                    ...
                    grid.columns[grid.columns.length - 1].widget.menu.items = [
                        {
                            ...
                            action_url: 'productregistration/closeApplicationQuery',
                            ...
                            winWidth: '35%',
                            handler: 'showManagerEditApplicationQueryForm',
                            stores: '[]',
                            hidden: true
                        }];
    ...
    bbar: [{
        ...
        emptyMsg: 'No Records',
        beforeLoad: function () {
            this.up('drugsmanagerproductsqueriesgrid').fireEvent('refresh', this);
        }
    }],
    features: [{
        ftype: 'searching',
