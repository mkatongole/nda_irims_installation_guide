Ext.define('Admin.view.productregistration.views.grids.quality_summary.ControlMaterialGrid', {
    ...
    bbar: [{
        ...
        emptyMsg: 'No Records',
        beforeLoad: function () {
            this.up('grid').fireEvent('refresh', this, 'tra_control_materials');
        }
    }],
    listeners: {
        beforerender: {
            ...
            config: {
                pageSize: 1000,
                storeId: 'controlmaterialgridstr',
                proxy: {
