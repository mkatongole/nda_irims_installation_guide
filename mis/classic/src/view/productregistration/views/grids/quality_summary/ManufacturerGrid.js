Ext.define('Admin.view.productregistration.views.grids.quality_summary.ManufacturerGrid', {
    ...
    bbar: [{
        ...
        emptyMsg: 'No Records',
        beforeLoad: function () {
            this.up('grid').fireEvent('refresh', this, 'tra_manufacturer');
        }
    }],
    listeners: {
        beforerender: {
    ...
    columns: [{
        ...
        xtype: 'gridcolumn',
        dataIndex: 'cep_number',
        text: 'CEP Number',
        width:150,
        tdCls: 'wrap-text'
        },{
        xtype: 'gridcolumn',
        dataIndex: 'description_process',
        text: 'Description Process',
        width:150,
        tdCls: 'wrap-text'
        },
        {
