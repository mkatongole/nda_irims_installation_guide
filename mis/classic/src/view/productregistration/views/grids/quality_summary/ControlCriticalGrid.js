Ext.define('Admin.view.productregistration.views.grids.quality_summary.ControlCriticalGrid', {
    ...
    bbar: [{
        ...
        emptyMsg: 'No Records',
        beforeLoad: function () {
            this.up('grid').fireEvent('refresh', this, 'tra_critical_control');
        }
    }],
    listeners: {
        beforerender: {
            ...
            config: {
                pageSize: 1000,
                storeId: 'criticalcontrolgridstr',
                proxy: {
