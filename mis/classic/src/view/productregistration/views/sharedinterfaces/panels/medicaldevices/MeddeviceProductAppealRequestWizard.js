 ...
 * Kip on 9/24/2018.
 */
Ext.define('Admin.view.productregistration.views.sharedinterfaces.panels.medicaldevices.MeddeviceProductAppealRequestWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.meddeviceproductappealrequestwizard',
    padding: '2 0 2 0',
    requires: [
