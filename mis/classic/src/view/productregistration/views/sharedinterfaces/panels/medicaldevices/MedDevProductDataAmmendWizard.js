 ...
 * Kip on 9/24/2018.
 */
Ext.define('Admin.view.productregistration.views.sharedinterfaces.panels.medicaldevices.MedDevProductDataAmmendWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.meddevproductdataammendwizard',
    padding: '2 0 2 0',
    requires: [
