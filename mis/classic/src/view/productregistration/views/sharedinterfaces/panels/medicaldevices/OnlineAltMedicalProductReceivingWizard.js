 ...
 * Kip on 9/24/2018.
 */
Ext.define('Admin.view.productregistration.views.sharedinterfaces.panels.medicaldevices.OnlineAltMedicalProductReceivingWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.onlinealtmedicalproductreceivingwizard',
    padding: '2 0 2 0',
    requires: [
            ...
            items: [
                {
                    ...
                    action: 'quickNav',
                    wizard: 'onlinealtmedicalproductreceivingwizard',
