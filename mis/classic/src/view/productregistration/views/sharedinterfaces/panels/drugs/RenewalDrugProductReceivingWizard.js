 ...
 * Kip on 9/24/2018.
 */
Ext.define('Admin.view.productregistration.views.sharedinterfaces.panels.drugs.RenewalDrugProductReceivingWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.renewaldrugproductreceivingwizard',
    padding: '2 0 2 0',
    requires: [
    ...
    initComponent: function () {
        ...
        this.tbar = {
            ...
            items: [{
                ...
                action: 'quickNav', wizard: 'renewaldrugproductreceivingwizard',
            ...
            },
            {
                ...
                action: 'quickNav',
                wizard: 'renewaldrugproductreceivingwizard',
                handler: 'quickNavigationRenewal'
            },
            {
                step: 2,
                ...
                step: 3,
                iconCls: 'fa fa-edit',iconAlign: 'top',
                enableToggle: true,
        ...
        this.bbar = {
            ...
            items: [
                ...
                },
                {
                    ...
                    name: 'save_btn',
                    disabled: false,
                    wizardpnl: 'renewaldrugproductreceivingwizard',
