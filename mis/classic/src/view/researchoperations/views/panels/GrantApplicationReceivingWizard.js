 ...
 * Created by Jeff
 */
Ext.define('Admin.view.research_operations.views.panels.GrantApplicationReceivingWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.grantapplicationreceivingwizard',
    padding: '2 0 2 0',
    requires: [
        ...
        this.tbar = {
            ...
            items: [
                
                {
                    ...
                    enableToggle: true,
                    pressed: true,
                    text: 'Grant Application Details',
                    max_step:1,
                    action: 'quickNav', wizard: 'grantapplicationreceivinggwizard',
