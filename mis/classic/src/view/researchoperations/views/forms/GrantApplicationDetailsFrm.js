...
Ext.define('Admin.view.research_operations.views.forms.GrantApplicationDetailsFrm', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.grantapplicationdetailsfrm',
    padding: '2 0 2 0',
            ...
            items: [
                {
                    ...
                    pressed: true,
                    enableToggle: true,
                    text: 'GRANT APPLICATION INFORMATION',
                    action: 'quickNav',
