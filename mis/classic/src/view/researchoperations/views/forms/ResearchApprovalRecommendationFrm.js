 ...
 */
Ext.define('Admin.view.research_operations.views.forms.ResearchApprovalRecommendationFrm', {
    extend: 'Ext.form.Panel',
    xtype: 'researchapprovalrecommendationfrm',
    layout: 'form',
    frame: true,
    defaults: {
        allowBlank: false,
    ...
    items: [
        ...
        },
        {
            xtype: 'hiddenfield',
            name: 'table_name',
            value: 'tra_researchoperations_applications'
        },
        {
            xtype: 'combo',
            queryMode: 'local',
