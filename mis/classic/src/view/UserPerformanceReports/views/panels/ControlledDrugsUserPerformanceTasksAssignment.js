Ext.define('Admin.view.dashboard.ControlledDrugsUserPerformanceTasksAssignment', {
    extend: 'Ext.panel.Panel',
    xtype: 'controlleddrugsuserperformancetasksassignment',
    margin: 2,
    itemId:'controlleddrugsuserperformancetasksassignment',
    reference:'controlleddrugsuserperformancetasksassignment',
    //id:'dashboard',
    requires: [
