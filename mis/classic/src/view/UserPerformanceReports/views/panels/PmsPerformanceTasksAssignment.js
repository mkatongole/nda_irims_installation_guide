Ext.define('Admin.view.dashboard.PmsPerformanceTasksAssignment', {
    extend: 'Ext.panel.Panel',
    xtype: 'pmsperformancetasksassignment',
    margin: 2,
    itemId:'pmsperformancetasksassignment',
    reference:'pmsperformancetasksassignment',
    //id:'dashboard',
    requires: [
