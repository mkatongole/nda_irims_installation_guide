 ...
 */
Ext.define('Admin.store.dashboard.OnlineEvalQueryResponseAppDashboardGridStr', {
    extend: 'Ext.data.Store',
    storeId: 'onlineevalqueryresponseappdashboardgridstr',
    alias: 'store.onlineevalqueryresponseappdashboardgridstr',
    requires:[
