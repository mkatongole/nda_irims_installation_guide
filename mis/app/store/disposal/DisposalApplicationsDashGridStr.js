 ...
 * on 9/27/2018.
 */
Ext.define('Admin.store.disposal.DisposalApplicationsDashGridStr', {
    extend: 'Ext.data.Store',
    alias: 'store.disposalapplicationsdashgridstr',
    ...
    proxy: {
        type: 'ajax',
        url: 'importexportpermits/getDisposalApplications',
        headers: {
