 ...
 * on 9/27/2018.
 */
Ext.define('Admin.store.importexport.MedicalDevImportExportPermitsStr', {
    extend: 'Ext.data.Store',
    alias: 'store.medicaldevimportexportpermitsstr',
    storeId: 'medicaldevimportexportpermitsstr',
    requires: [
