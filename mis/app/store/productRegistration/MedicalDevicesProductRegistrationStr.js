 ...
 * on 9/27/2018.
 */
Ext.define('Admin.store.productRegistration.MedicalDevicesProductRegistrationStr', {
    extend: 'Ext.data.Store',
    alias: 'store.medicaldevicesproductregistrationstr',
    storeId: 'medicaldevicesproductregistrationstr',
    requires: [
