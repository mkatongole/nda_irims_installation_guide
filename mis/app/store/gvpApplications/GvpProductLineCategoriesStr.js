 ...
 */
Ext.define('Admin.store.gvpApplications.GvpProductLineCategoriesStr', {
    extend: 'Ext.data.Store',
    alias: 'store.gvpproductlinecategoriesstr',
    storeId: 'gvpproductlinecategoriesstr',
    requires: [
    ...
    listeners: {
        beforeload: function (store, op) {
            op.setParams(Ext.apply(op.getParams() || {}, {
                model_name: 'GvpProductLineCategory'
            }));
        },
