 ...
 */
Ext.define('Admin.store.premiseRegistration.MedicinePremiseRegistrationStr', {
    extend: 'Ext.data.Store',
    storeId: 'medicinepremiseregistrationstr',
    alias: 'store.medicinepremiseregistrationstr',
    requires: [
