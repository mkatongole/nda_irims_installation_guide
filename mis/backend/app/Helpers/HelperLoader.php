...
if (!function_exists('belongsToWhichRegionCategory')) {
    function belongsToWhichRegionCategory($country_id,$where)
    {
        return UtilityHelper::belongsToWhichRegionCategory($country_id,$where);
    }
}

if (!function_exists('belongsToGlovesCategoryByCode')) {
    function belongsToGlovesCategoryByCode($gmdn_code)
    {
        return UtilityHelper::belongsToGlovesCategoryByCode($gmdn_code);
    }
}

if (!function_exists('belongsToGlovesCategory')) {
    function belongsToGlovesCategory($gmdn_code_id)
    {
        return UtilityHelper::belongsToGlovesCategory($gmdn_code_id);
    }
}

if (!function_exists('belongsToVaccineAnticancerCategory')) {
    function belongsToVaccineAnticancerCategory($atc_code_id)
    {
        return UtilityHelper::belongsToVaccineAnticancerCategory($atc_code_id);
    }
}
