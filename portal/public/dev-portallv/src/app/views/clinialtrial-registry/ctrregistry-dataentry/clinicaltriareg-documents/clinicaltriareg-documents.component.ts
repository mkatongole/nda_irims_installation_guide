...
@Component({
  selector: 'app-clinicaltriareg-documents',
  templateUrl: './clinicaltriareg-documents.component.html',
  styleUrls: ['./clinicaltriareg-documents.component.css']
})
export class ClinicaltriaregDocumentsComponent implements OnInit {
  ...
  onApplicationDocumentToolbar(e) {
    ...
    e.toolbarOptions.items.unshift( {
      ...
      widget: 'dxButton',
      options: {
        text: 'Note: Maximum File Size per upload is 250 MB. Multiple Documents can be uploaded under the specified group(s)',
        type: 'danger',
        icon: 'fa fa-plus'
      }
    },{
