...
@Component({
  selector: 'app-registered-cosmeticsproducts',
  templateUrl: './registered-cosmeticsproducts.component.html',
  styleUrls: ['./registered-cosmeticsproducts.component.css']
})
export class RegisteredCosmeticsproductsComponent  extends RegisteredProductsComponent  implements OnInit{
