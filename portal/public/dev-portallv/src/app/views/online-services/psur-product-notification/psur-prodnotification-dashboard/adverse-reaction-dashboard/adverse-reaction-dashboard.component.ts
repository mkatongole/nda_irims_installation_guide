...
@Component({
  selector: 'app-adverse-reaction-dashboard',
  templateUrl: './adverse-reaction-dashboard.component.html',
  styleUrls: ['./adverse-reaction-dashboard.component.css']
})
export class AdverseReactionDashboardComponent implements OnInit {
 app_renewalduenotifications:number=0
  ...
  onClickSubModuleAppSelection(sub_module_id,sub_module_name){
    ...
    if(sub_module_id == 77){
      ...
      this.app_route = ['./online-services/adverse-drug-reation-application'];
