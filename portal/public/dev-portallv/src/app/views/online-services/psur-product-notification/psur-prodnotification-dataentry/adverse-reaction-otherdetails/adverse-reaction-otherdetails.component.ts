...
@Component({
  selector: 'app-adverse-reaction-otherdetails',
  templateUrl: './adverse-reaction-otherdetails.component.html',
  styleUrls: ['./adverse-reaction-otherdetails.component.css']
})
export class AdverseReactionOtherdetailsComponent implements OnInit {
