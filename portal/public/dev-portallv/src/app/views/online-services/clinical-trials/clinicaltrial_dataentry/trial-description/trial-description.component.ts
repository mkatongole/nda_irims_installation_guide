...
@Component({
  selector: 'app-trial-description',
  templateUrl: './trial-description.component.html',
  styleUrls: ['./trial-description.component.css']
})
export class TrialDescriptionComponent implements OnInit {
  ...
  @Input() clinicaltrialDescriptionGeneraldetailsfrm: FormGroup;
