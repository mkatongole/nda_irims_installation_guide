...
@Component({
  selector: 'app-trial-monitoring-report',
  templateUrl: './trial-monitoring-report.component.html',
  styleUrls: ['./trial-monitoring-report.component.css']
})
export class TrialMonitoringReportComponent implements OnInit {
  ...
  @Input() clinicaltrialMonitoringReportdetailsfrm: FormGroup;
