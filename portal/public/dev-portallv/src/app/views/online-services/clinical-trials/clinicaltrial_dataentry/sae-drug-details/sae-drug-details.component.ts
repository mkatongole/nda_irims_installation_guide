...
@Component({
  selector: 'app-sae-drug-details',
  templateUrl: './sae-drug-details.component.html',
  styleUrls: ['./sae-drug-details.component.css']
})
export class SaeDrugDetailsComponent implements OnInit {
