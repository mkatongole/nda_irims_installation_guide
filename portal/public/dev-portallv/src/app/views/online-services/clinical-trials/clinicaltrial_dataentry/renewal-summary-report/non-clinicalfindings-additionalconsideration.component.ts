...
@Component({
  selector: 'app-non-clinicalfindings-additionalconsideration',
  templateUrl: './non-clinicalfindings-additionalconsideration.component.html',
  styleUrls: ['./non-clinicalfindings-additionalconsideration.component.css']
})
export class NonClinicalfindingsAdditionalconsiderationComponent implements OnInit {
@Input() sub_module_id: number;
  ...
  @Input() ClinicaltrialRenewalSummaryfrm: FormGroup;
