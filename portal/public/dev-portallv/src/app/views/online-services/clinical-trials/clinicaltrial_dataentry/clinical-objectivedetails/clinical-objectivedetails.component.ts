...
@Component({
  selector: 'app-clinical-objectivedetails',
  templateUrl: './clinical-objectivedetails.component.html',
  styleUrls: ['./clinical-objectivedetails.component.css']
})
export class ClinicalObjectivedetailsComponent implements OnInit {
  ...
  @Input() clinicaltrialObjectiveGeneraldetailsfrm: FormGroup;
