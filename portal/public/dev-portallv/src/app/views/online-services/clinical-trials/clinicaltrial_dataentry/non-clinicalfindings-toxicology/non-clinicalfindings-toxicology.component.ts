...
@Component({
  selector: 'app-non-clinicalfindings-toxicology',
  templateUrl: './non-clinicalfindings-toxicology.component.html',
  styleUrls: ['./non-clinicalfindings-toxicology.component.css']
})
export class NonClinicalfindingsToxicologyComponent implements OnInit {
  ...
  @Input() nonClinicaltrialtoxicologyfrm: FormGroup;
