...
@Component({
  selector: 'app-application-bioequivalence-documents',
  templateUrl: './application-bioequivalence-documents.component.html',
  styleUrls: ['./application-bioequivalence-documents.component.css']
})
export class ApplicationBioequivalenceDocumentsComponent implements OnInit {
  ...
  onLoadAppDocRequirements() {
    ...
    this.dmsService.onLoadQualitySummaryDocRequirements(this.application_code, this.section_id, this.is_bioequivalence,this.sub_module_id, this.document_type_id,this.status_id, this.query_ref_id,this.prodclass_category_id,this.business_type_id,this.permit_product_id)
      //.pipe(first())
      .subscribe(
        data => {
          if (data.success) {
