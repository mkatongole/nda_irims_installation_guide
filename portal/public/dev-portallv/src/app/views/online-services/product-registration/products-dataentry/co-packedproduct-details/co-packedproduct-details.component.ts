...
funcEditCopackedDetails(data) {
  this.productcopackedDetailsFrm.patchValue(data.data);
  this.isCopackedDetailsWinshow = true;
}
...
funcDeleteCopackedDetails(data) {
  //func_delete records 
  let record_id = data.data.id;
  let appproduct_id = data.data.product_id;
  let table_name = 'wb_copacked_products';
  this.funcDeleteDetailhelper(record_id, appproduct_id, table_name, 'copacked_products', 'Product Copacked');
