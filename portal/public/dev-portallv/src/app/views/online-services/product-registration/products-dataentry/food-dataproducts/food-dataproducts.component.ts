...
@Component({
  selector: 'app-food-dataproducts',
  templateUrl: './food-dataproducts.component.html',
  styleUrls: ['./food-dataproducts.component.css']
})
export class FoodDataproductsComponent extends SharedProductregistrationclassComponent{
  ...
  @Input() registeredPremisesData: any;
            ...
            .subscribe(
              data_response => {
                ...
                if (resp.success) {
                  ...
                  }   else if (reload_type == 'product_nutrients') {
                    this.OnLoadProductsNutrients(appproduct_id);
    ...
    .subscribe(
      response => {
        ...
        if (this.product_resp.success) {
          ...
          this.toastr.success(this.product_resp.message, 'Response');
          this.modalService.getModal('productIngredientsModal').close();
