...
@Component({
  selector: 'app-control-fpp',
  templateUrl: './control-fpp.component.html',
  styleUrls: ['./control-fpp.component.css']
})
export class ControlFppComponent extends SharedProductregistrationclassComponent{
 ...
 // @Input() summaryProductDetailsFrm:FormGroup;
  ...
  isSpecificationWinshow:boolean=false;
  isBatchAnalysesWinshow:boolean=false;
  isCharacterisationImpuritiesWinshow:boolean=false;
  isOveragesWinshow:boolean=false;
  isProcedureAnalysisWinshow:boolean=false;
  isProcedureValidationWinshow:boolean=false;
  isJustificationSpecWinshow:boolean=false;

  siUnitsData:any;
  specificationValidationData:any;
  ...
  procedureValidationData:any;
  procedureAnalysisData:any;
  specificationsData:any;
  batchAnalysesData:any;
  impuritiesData:any;
  overagesData:any;
  specificationData:any;

  specificationDetailsFrm:FormGroup;
  procedureAnalysisDetailsFrm:FormGroup;
  procedureValidationDetailsFrm:FormGroup;
  batchAnalysesDetailsFrm:FormGroup;
  characterisationImpuritiesDetailsFrm:FormGroup;
  overagesDetailsFrm:FormGroup;
  justificationSpecDetailsFrm:FormGroup;
 ...
 ngOnInit() { this.onLoadconfirmDataParmAll();
    ...
    this.specificationDetailsFrm = new FormGroup({
      specifications_summary: new FormControl('', Validators.compose([Validators.required])),
      manufacturer: new FormControl('', Validators.compose([])),

      id: new FormControl('', Validators.compose([]))
    });

    this.batchAnalysesDetailsFrm = new FormGroup({
      summary_procedure_analyses: new FormControl('', Validators.compose([Validators.required])),
      summary_batch_analyses: new FormControl('', Validators.compose([Validators.required])),
      description_of_batches: new FormControl('', Validators.compose([Validators.required])),
      id: new FormControl('', Validators.compose([]))
      
    });
    this.characterisationImpuritiesDetailsFrm = new FormGroup({
      identification_potential_impurities: new FormControl('', Validators.compose([Validators.required])),
      basis_acceptance_creteria: new FormControl('', Validators.compose([Validators.required])),
      manufacturer: new FormControl('', Validators.compose([])),
    id: new FormControl('', Validators.compose([]))
    });
    ...
    this.overagesDetailsFrm = new FormGroup({
      ...
      parameter_relevant_performance: new FormControl('', Validators.compose([Validators.required])),
      ...
      multidose_container: new FormControl('', Validators.compose([Validators.required])),
      microbiological_attributes: new FormControl('', Validators.compose([Validators.required])),
      discussion_compatibility_fpp: new FormControl('', Validators.compose([Validators.required])),
      id: new FormControl('', Validators.compose([]))
      
    });
    this.procedureAnalysisDetailsFrm = new FormGroup({
      summary_procedure_analyses: new FormControl('', Validators.compose([Validators.required])),
      id: new FormControl('', Validators.compose([]))
      
    });
    this.procedureValidationDetailsFrm = new FormGroup({
      summary_validation_information: new FormControl('', Validators.compose([Validators.required])),
      id: new FormControl('', Validators.compose([]))
      
    });
    this.justificationSpecDetailsFrm = new FormGroup({
      justification_fpp: new FormControl('', Validators.compose([Validators.required])),
      id: new FormControl('', Validators.compose([]))
  ...
  autoLoadProductsOtherDetails(product_id) {
    this.OnLoadSpecification(product_id);
    this.OnLoadBatchAnalyses(product_id);    
    this.OnLoadProcedureAnalysis(product_id);    
    this.OnLoadProcedureValidation(product_id);
    this.OnLoadImpurities(product_id);    
    this.OnLoadJustificationSpec(product_id);
  ...
  onSpecificationPreparing(e) {
    this.functDataGridToolbar(e, this.funcAddSpecification, 'Specification');
  }
  onProcedureAnalysis(e) {
    this.functDataGridToolbar(e, this.funcAddProcedure, 'Analytical Procedure');
  }

  onProcedureValidation(e) {
    this.functDataGridToolbar(e, this.funcAddProcedureValidation, 'Validation Procedure');
  }

  funcAddSpecification() {
    this.isSpecificationWinshow = true;
    this.specificationDetailsFrm.reset();
  }  

  funcAddProcedure() {
    this.isProcedureAnalysisWinshow = true;
    this.procedureAnalysisDetailsFrm.reset();

  }
  funcAddProcedureValidation() {
    this.isProcedureValidationWinshow = true;
    this.procedureValidationDetailsFrm.reset();
  ...
  funcAddBatchAnalyses() {
    ...
    this.isBatchAnalysesWinshow = true;
    this.batchAnalysesDetailsFrm.reset();

  }
  onImpuritiesPreparing(e) {
    this.functDataGridToolbar(e, this.funcAddCharacterisation, 'Characterisation Impurities');
  }
  onJustificationPreparing(e) {
    this.functDataGridToolbar(e, this.funcAddJustificationSpec, 'Justification Specification');
  }


  funcAddCharacterisation() {
    this.isCharacterisationImpuritiesWinshow = true;
    this.characterisationImpuritiesDetailsFrm.reset();

  }

  funcAddJustificationSpec() {
    this.isJustificationSpecWinshow = true;
    this.justificationSpecDetailsFrm.reset();
          ...
          this.appService.onDeleteProductsDetails(record_id, table_name, appproduct_id, title)
            ...
            .subscribe(
              data_response => {
                ...
                if (resp.success) {
                  if (reload_type == 'specification') {
                    this.OnLoadSpecification(appproduct_id);

                  }else if (reload_type == 'batch_analyses') {
                    this.OnLoadBatchAnalyses(appproduct_id);

                  }else if (reload_type == 'procedure_analyses') {
                    this.OnLoadProcedureAnalysis(appproduct_id);

                  }else if (reload_type == 'procedure_validation') {
                    this.OnLoadProcedureValidation(appproduct_id);

                  }else if (reload_type == 'impurities') {
                    this.OnLoadImpurities(appproduct_id);

                  }else if (reload_type == 'justification_specification') {
                    this.OnLoadJustificationSpec(appproduct_id);
...
OnLoadSpecification(product_id) {
    var data = {
      table_name: 'tra_specification_details',
...
OnLoadProcedureAnalysis(product_id) {
    var data = {
      table_name: 'tra_procedure_analysis',
      product_id: product_id
    };
    this.config.getProductsQualitySummaryDetails(data)
      .subscribe(
        data => {
          this.procedureAnalysisData = data.data;
        });
  }
OnLoadProcedureValidation(product_id) {
    var data = {
      table_name: 'tra_procedure_validate',
      product_id: product_id
    };
    this.config.getProductsQualitySummaryDetails(data)
      .subscribe(
        data => {
          this.procedureValidationData = data.data;
        });
  }
OnLoadBatchAnalyses(product_id) {
    var data = {
      table_name: 'tra_batch_dossier',
      product_id: product_id
    };
    this.config.getProductsQualitySummaryDetails(data)
      .subscribe(
        data => {
          this.batchAnalysesData = data.data;
        });
  }
OnLoadImpurities(product_id) {
    var data = {
      table_name: 'tra_dossier_impurities',
      product_id: product_id
    };
    this.config.getProductsQualitySummaryDetails(data)
      .subscribe(
        data => {
          this.impuritiesData = data.data;
        });
  }
OnLoadJustificationSpec(product_id) {
    var data = {
      table_name: 'tra_justification_spec',
      product_id: product_id
    };
    this.config.getProductsQualitySummaryDetails(data)
      .subscribe(
        data => {
          this.specificationValidationData = data.data;
        });
  }
...
onSaveSpecificationDetails() {
  let appproduct_id = this.product_id;
  this.spinner.show();
  this.appService.onSaveProductQualitySummaryDetails('tra_specification_details', this.specificationDetailsFrm.value, this.product_id,this.application_code)
    .subscribe(
      response => {
        ...
        if (this.product_resp.success) {
          ...
          this.isSpecificationWinshow = false;
...
onSaveProcedureAnalysisDetails() {
  let appproduct_id = this.product_id;
  this.spinner.show();
  this.appService.onSaveProductQualitySummaryDetails('tra_procedure_analysis', this.procedureAnalysisDetailsFrm.value, this.product_id,this.application_code)
    .subscribe(
      response => {
        this.product_resp = response.json();
        //the details 
        if (this.product_resp.success) {
          ...
          this.isProcedureAnalysisWinshow = false;
          this.toastr.success(this.product_resp.message, 'Response');
        } else {
          this.toastr.error(this.product_resp.message, 'Alert');
        }
...
onSaveProcedureValidityDetails() {
  let appproduct_id = this.product_id;
  this.spinner.show();
  this.appService.onSaveProductQualitySummaryDetails('tra_procedure_validate', this.procedureValidationDetailsFrm.value, this.product_id,this.application_code)
    .subscribe(
      response => {
        this.product_resp = response.json();
        //the details 
        if (this.product_resp.success) {
          ...
          this.isProcedureValidationWinshow = false;
          this.toastr.success(this.product_resp.message, 'Response');
        } else {
          this.toastr.error(this.product_resp.message, 'Alert');
        }
...
onSaveBatchAnalysesDetails() {
  let appproduct_id = this.product_id;
  this.spinner.show();
  this.appService.onSaveProductQualitySummaryDetails('tra_batch_dossier', this.batchAnalysesDetailsFrm.value, this.product_id,this.application_code)
    .subscribe(
      response => {
        this.product_resp = response.json();
        //the details 
        if (this.product_resp.success) {
          ...
          this.isBatchAnalysesWinshow = false;
          this.toastr.success(this.product_resp.message, 'Response');
        } else {
          this.toastr.error(this.product_resp.message, 'Alert');
        }
...
onSaveCharacterisationDetails() {
  let appproduct_id = this.product_id;
  this.spinner.show();
  this.appService.onSaveProductQualitySummaryDetails('tra_dossier_impurities', this.characterisationImpuritiesDetailsFrm.value, this.product_id,this.application_code)
    .subscribe(
      response => {
        this.product_resp = response.json();
        //the details 
        if (this.product_resp.success) {
          ...
          this.isCharacterisationImpuritiesWinshow = false;
          this.toastr.success(this.product_resp.message, 'Response');
        } else {
          this.toastr.error(this.product_resp.message, 'Alert');
        }
...
onSaveJustificationSpecDetails() {
  let appproduct_id = this.product_id;
  this.spinner.show();
  this.appService.onSaveProductQualitySummaryDetails('tra_justification_spec', this.justificationSpecDetailsFrm.value, this.product_id,this.application_code)
    .subscribe(
      response => {
        this.product_resp = response.json();
        //the details 
        if (this.product_resp.success) {
          ...
          this.isJustificationSpecWinshow = false;
          this.toastr.success(this.product_resp.message, 'Response');
        } else {
          this.toastr.error(this.product_resp.message, 'Alert');
        }
