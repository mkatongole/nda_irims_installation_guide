...
@Component({
  selector: 'app-drugshop-variation',
  templateUrl: './drugshop-variation.component.html',
  styleUrls: ['./drugshop-variation.component.css']
})
export class DrugshopVariationComponent extends SharedDrugshopsregistrationclassComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (!this.premisesapp_details) {
      ...
      this.router.navigate(['./../online-services/drugshopvariation-dashboard']);
      return;
    }
    else {
      this.app_routing = ['./../online-services/drugshopvariation-dashboard'];
