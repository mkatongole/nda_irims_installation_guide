...
@Component({
  selector: 'app-drugshop-reg-preview',
  templateUrl: './drugshop-reg-preview.component.html',
  styleUrls: ['./drugshop-reg-preview.component.css']
})
export class DrugshopRegPreviewComponent extends SharedDrugshopsregistrationclassComponent implements OnInit {
