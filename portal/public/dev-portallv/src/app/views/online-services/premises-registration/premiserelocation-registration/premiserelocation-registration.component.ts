...
@Component({
  selector: 'app-premiserelocation-registration',
  templateUrl: './premiserelocation-registration.component.html',
  styleUrls: ['./premiserelocation-registration.component.css']
})
export class PremiserelocationRegistrationComponent extends SharedPremisesregistrationclassComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (!this.premisesapp_details) {
      this.router.navigate(['./../online-services/premiserelocationreg-dashboard']);
      return;
    }
    else {
