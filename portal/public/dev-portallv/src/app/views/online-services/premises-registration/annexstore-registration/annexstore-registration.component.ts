...
@Component({
  selector: 'app-annexstore-registration',
  templateUrl: './annexstore-registration.component.html',
  styleUrls: ['./annexstore-registration.component.css']
})
export class AnnexstoreRegistrationComponent extends SharedPremisesregistrationclassComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (!this.premisesapp_details) {
      this.router.navigate(['./../online-services/newpremiseregannex-dashboard']);
      return;
    }
    else {
