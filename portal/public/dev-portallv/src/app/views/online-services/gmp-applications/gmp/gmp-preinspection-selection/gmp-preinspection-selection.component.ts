...
@Component({
  selector: 'app-gmp-preinspection-selection',
  templateUrl: './gmp-preinspection-selection.component.html',
  styleUrls: ['./gmp-preinspection-selection.component.css']
})
export class GmpPreinspectionSelectionComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.GmpAppSelectionfrm.get('gmp_type_id').setValue(2);
  ...
  onGmpAppSelection() {
    ...
    this.title = 'Pre inspection Application';
    ...
    this.router_link = 'preinspection-gmp-applications';
