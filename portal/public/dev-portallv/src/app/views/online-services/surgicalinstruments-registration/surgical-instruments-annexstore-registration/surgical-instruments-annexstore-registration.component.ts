...
@Component({
  selector: 'app-surgical-instruments-annexstore-registration',
  templateUrl: './surgical-instruments-annexstore-registration.component.html',
  styleUrls: ['./surgical-instruments-annexstore-registration.component.css']
})
export class SurgicalInstrumentsAnnexstoreRegistrationComponent extends SharedSurgicalregistrationclassComponent implements OnInit {
 premisesrenGeneraldetailsfrm: FormGroup;
  ...
  ngOnInit() {
    ...
    if (!this.premisesapp_details) {
      this.router.navigate(['./../online-services/surgicalannex-dashboard']);
      return;
    }
    else {
