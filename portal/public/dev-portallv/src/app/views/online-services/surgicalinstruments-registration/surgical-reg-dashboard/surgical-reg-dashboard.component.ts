...
@Component({
  selector: 'app-surgical-reg-dashboard',
  templateUrl: './surgical-reg-dashboard.component.html',
  styleUrls: ['./surgical-reg-dashboard.component.css']
})
export class SurgicalRegDashboardComponent implements OnInit {
 app_renewalduenotifications:number=0
  ...
  onClickSubModuleAppSelection(sub_module_id,sub_module_name){
    ...
    if(sub_module_id == 119){
       this.premisessapp_details = {businsess_type_id:4,module_id: this.module_id, process_title: sub_module_name, sub_module_id: sub_module_id};
      this.appService.setPremisesApplicationDetail(this.premisessapp_details);
      //this.isPremisesApplicationInitialisation = true;
     this.app_route = ['./online-services/preinspection-surgical-applications'];
