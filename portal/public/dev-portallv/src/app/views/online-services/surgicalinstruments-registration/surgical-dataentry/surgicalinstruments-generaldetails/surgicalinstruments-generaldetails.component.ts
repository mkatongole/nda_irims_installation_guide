...
@Component({
  selector: 'app-surgicalinstruments-generaldetails',
  templateUrl: './surgicalinstruments-generaldetails.component.html',
  styleUrls: ['./surgicalinstruments-generaldetails.component.css']
})
export class SurgicalinstrumentsGeneraldetailsComponent implements OnInit, OnDestroy  {
  ...
  ngOnInit() {
    ...
    if(!this.application_code){
      //  this.premisesGeneraldetailsfrm.get('zone_id').setValue(2);
        ...
        this.premisesGeneraldetailsfrm.get('business_type_id').setValue(4);
      ...
      if(this.sub_module_id == 120 || this.sub_module_id == 121){
          this.is_made_readOnly = true;
      }else if(this.sub_module_id == 122 || this.sub_module_id == 127){
        this.is_made_readOnly = true;
