...
@Component({
  selector: 'app-new-surgical-registration',
  templateUrl: './new-surgical-registration.component.html',
  styleUrls: ['./new-surgical-registration.component.css']
})
export class NewSurgicalRegistrationComponent extends SharedSurgicalregistrationclassComponent implements OnInit {
 premisesrenGeneraldetailsfrm: FormGroup;
  ...
  ngOnInit() {
    ...
    if (!this.premisesapp_details) {
      this.router.navigate(['./../online-services/newsurgicalreg-dashboard']);
      return;
    }
    else {
