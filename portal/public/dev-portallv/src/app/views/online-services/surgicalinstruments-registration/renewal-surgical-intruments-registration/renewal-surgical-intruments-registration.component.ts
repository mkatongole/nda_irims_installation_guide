...
@Component({
  selector: 'app-renewal-surgical-intruments-registration',
  templateUrl: './renewal-surgical-intruments-registration.component.html',
  styleUrls: ['./renewal-surgical-intruments-registration.component.css']
})
export class RenewalSurgicalIntrumentsRegistrationComponent extends SharedSurgicalregistrationclassComponent implements OnInit {
  ...
  ngOnInit() {
   //this.is_readonly = true;
    ...
    if (!this.premisesapp_details) {
      ...
      this.router.navigate(['./../online-services/surgicalrenewal-dashboard']);
      return;
    }
    else {
