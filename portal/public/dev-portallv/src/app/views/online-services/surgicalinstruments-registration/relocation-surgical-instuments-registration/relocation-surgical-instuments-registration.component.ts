...
@Component({
  selector: 'app-relocation-surgical-instuments-registration',
  templateUrl: './relocation-surgical-instuments-registration.component.html',
  styleUrls: ['./relocation-surgical-instuments-registration.component.css']
})
export class RelocationSurgicalInstumentsRegistrationComponent  extends SharedSurgicalregistrationclassComponent implements OnInit {
 premisesrenGeneraldetailsfrm: FormGroup;
  ...
  ngOnInit() {
    ...
    if (!this.premisesapp_details) {
      this.router.navigate(['./../online-services/surgicalrelocation-dashboard']);
      return;
    }
    else {
