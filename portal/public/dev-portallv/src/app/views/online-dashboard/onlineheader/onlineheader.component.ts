...
@Component({
  selector: 'app-onlineheader',
  templateUrl: './onlineheader.component.html',
  styleUrls: ['./onlineheader.component.css']
})
export class OnlineheaderComponent implements OnInit {
