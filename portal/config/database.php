    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'database' => env('DB_DATABASE', 'zamra_portal'),
            'username' => env('DB_USERNAME', 'root_user'),
            'password' => env('DB_PASSWORD', 'slams@#2017'),
        ...
        'mis_db' => [
            'driver' => 'mysql',
            'host' => env('MIS_HOST', '127.0.0.1'),
            'port' => env('MIS_PORT', '3306'),
            'database' =>env('MIS_DATABASE', 'mis'),
            'username' => env('MIS_USERNAME', 'root_user'),
            'password' => env('MIS_PASSWORD', 'slams@#2017'),
            'unix_socket' => env('MIS_SOCKET', ''),
            'prefix' => '',
            'strict' => false,
            'engine' => null,
        ],
